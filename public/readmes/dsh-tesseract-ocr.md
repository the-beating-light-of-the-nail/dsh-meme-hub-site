...
Tested on Ubuntu (primary target); works anywhere the `tesseract` CLI is installed (Linux, macOS, Windows). Verified against dsh `0.1.2-rc.1` (master).
...
> `- insert:` row with the same id to your profile — dsh `0.1.2-rc.1`
...
> and dsh `0.1.2-rc.1` fails the boot with `duplicate loader entry id:
