...
<p align="center">
  <img src="https://raw.githubusercontent.com/Choi-Peng/dsh-deepseek-balance/59a69a0d0e95a87fa3f0a74f1e2db13a2a4f9e06/docs/imgs/example.png" alt="账户余额示例" width="240">
</p>
...
插件设置遵循 dsh 官方双缝配置模型，**均实时生效，无需重启 `dsh web`**
