...
![确认创建并切换到 Worktree Session](https://raw.githubusercontent.com/wloops/dsh-git-worktree/daef6851029d96019dfd952e20deddeb7afbb782/docs/screenshots/01-create-worktree.png)

### 准备验收

Agent 完成实现和验证后生成 Ready for Review，用户可以查看变更摘要与验证结果，再决定是否同步到 Local。

![Worktree 修改已准备验收](https://raw.githubusercontent.com/wloops/dsh-git-worktree/daef6851029d96019dfd952e20deddeb7afbb782/docs/screenshots/02-ready-for-review.png)

### 在 Local Preview 中验收

同步后，本次任务增量会以可撤回的 Local Preview 等待验收；用户可以提交、撤回后继续修改，或放弃任务。

![任务修改正在 Local Preview 中等待验收](https://raw.githubusercontent.com/wloops/dsh-git-worktree/daef6851029d96019dfd952e20deddeb7afbb782/docs/screenshots/03-local-preview.png)
...
| 提交并清理 | 提交并保留运行环境 |
| --- | --- |
| ![确认提交任务增量并清理 Worktree](https://raw.githubusercontent.com/wloops/dsh-git-worktree/daef6851029d96019dfd952e20deddeb7afbb782/docs/screenshots/04-commit-confirmation.png) | ![确认提交任务增量并保留运行环境](https://raw.githubusercontent.com/wloops/dsh-git-worktree/daef6851029d96019dfd952e20deddeb7afbb782/docs/screenshots/06-retain-environment.png) |

### 在同一 Session 开始下一轮

交付与 cleanup 成功后，原对话会保留，并可以基于最新 Local HEAD 开始下一轮修改。

![本轮已交付并可以开始下一轮修改](https://raw.githubusercontent.com/wloops/dsh-git-worktree/daef6851029d96019dfd952e20deddeb7afbb782/docs/screenshots/05-next-iteration.png)
