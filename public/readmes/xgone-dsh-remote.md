...
|:---:|:---:|
| ![登录页](https://raw.githubusercontent.com/xgone/dsh-remote/ef1ecb0ebc2e2dcff8a9c2ab662dc975d8e6d2a9/docs/login-zh.png) | ![账号管理设置页](https://raw.githubusercontent.com/xgone/dsh-remote/ef1ecb0ebc2e2dcff8a9c2ab662dc975d8e6d2a9/docs/settings-zh.png) |
...
- **远程文件面板**：点击文件路径不再在宿主机桌面打开，而是按类型在右侧边栏预览——代码带语法
  高亮与复制、Markdown 渲染排版、图片 / PDF / 视频 / 音频内联、文本与目录浏览、Word（.docx）
  提取纯文本；不支持预览的文件点击直接下载。默认仅允许 DSH 主目录与工作目录，可在设置页添加
  允许的目录。
