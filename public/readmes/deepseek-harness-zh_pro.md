...
<p align="center">
   <img alt="版本 0.9.1" src="https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.9.1-5965d8">
...
| 对话样式相关 | 自动展开最新思考 | 开 | 流式思考出现时展开最新一条，新思考出现时收起上一条由插件自动展开的内容 |
...
| 对话列表相关 | 会话删除按钮 | 开 | 在会话三点菜单显示“删除会话”；日志移入系统回收站，不保留列表恢复位 |
