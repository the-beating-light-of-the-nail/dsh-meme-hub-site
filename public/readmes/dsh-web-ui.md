...
<p align="center">
  <img src="https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/dsh-web-banner.png" alt="dsh-web" width="100%">
</p>
...
![DSH Web UI 主界面](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/13-hero-main.png)
...
![创意工坊首页](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/31-market-home.png)
...
任务还可以选择复用会话：开启后，下一次执行若上一轮的会话仍在运行时列表中且空闲，Host 就在那个会话里继续跑（重新应用该任务钉住的权限与模型，保留标题与历史）；会话不在列表里或正忙时照常新建会话，定时执行不会因此卡住。

| 多列看板 | 定时执行 |
| --- | --- |
| ![任务看板](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/09-task-board.png) | ![任务定时执行](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/10-task-board-detail-cron.png) |
...
![手机与 Web 同界面（示意图）](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/assets/phone-and-web.png)
...
| 移动端主页（鲸鱼入口） | 会话列表 |
| --- | --- |
| ![移动端主页](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/20-mobile-home.png) | ![移动端会话列表](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/21-mobile-sessions.png) |
| 聊天（思考与工具调用） | 模型选择（底部弹层） |
| ![移动端聊天](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/22-mobile-chat.png) | ![模型选择](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/23-mobile-model-sheet.png) |
...
自定义供应商的逐模型能力声明就在「设置 > 模型」页完成。官方 pi-ai 设置命名空间一直带着图片输入与推理档位字段，这个插件补上官方卡片有意省略的编辑器：每张自定义供应商卡片多出一个可折叠的「模型能力」区——逐模型勾选是否声明图片输入（`["text","image"]` 或 `["text"]`，未声明即继承，界面会显示而不是隐藏），并用三态编辑器声明推理档位：不声明（继承）、声明为非推理模型（模型选择器不再提供思考档位），或显式给出档位字典，每个档位还能单独写请求实际发送的线值。保存走官方同一条写入路径（一次整数组替换该供应商的 `models`），未编辑的字段原样保留，改完即时生效、无需重启；每次保存都带上读取时的 revision，别处改过就重新加载并提示重试，不会覆盖新配置。

供应商的停用与启用也在同一张卡片上：停用先把该供应商的 profile 归档进插件自己的设置命名空间，再经官方 Remove-provider 接缝把路由摘下来，模型选择器与子代理选择立刻看不到它（无需重启），API 密钥存在凭据服务里、全程不动；被停用的供应商列在模型页底部，一键恢复原配置。注意这些字段是「声明」而非「探测」：模型声称支持图片但网关不认，会在请求时失败——它们之所以存在，正是因为没有任何东西能替你推断出来。详见 [dsh-model-capabilities README](packages/dsh-model-capabilities/README.zh.md)。
...
![右侧面板](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/19-right-panel.png)
...
![Git 图谱](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/04-git-graph.png)

![Git worktree 并行会话](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/34-git-worktree.png)
...
![Blue Fantasy 暗色](https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/screenshots/17-skin-blue-fantasy-dark.png)
...
<img src="https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/community-center.jpg" alt="DSH Web UI 交流群" width="240">
...
<p align="center">
  <img src="https://raw.githubusercontent.com/zhu1090093659/dsh-web-ui/89e3b8f1dfc14cd189695d041114912688376e8d/docs/zanzhu-wechat.jpg" alt="微信赞助二维码" width="360">
</p>