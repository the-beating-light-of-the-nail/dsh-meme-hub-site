...
A-share + US stock trading toolkit for [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) agents: 行情查询（A股+美股）、ADX 三状态信号、简易回测预览。**只读设计——永不下单、不触碰任何交易凭据。**
