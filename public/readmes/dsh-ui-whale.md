...
![dsh-ui-whale 完整演示](https://raw.githubusercontent.com/lhh010/dsh-ui-whale/e78ac4406c68f4c1521b5d11143b516849d597aa/docs/dsh-ui-whale-demo.gif)

各动作 GIF：

<img src="https://raw.githubusercontent.com/lhh010/dsh-ui-whale/e78ac4406c68f4c1521b5d11143b516849d597aa/docs/%E7%9C%A8%E7%9C%BC.gif" alt="眨眼" width="200"> <img src="https://raw.githubusercontent.com/lhh010/dsh-ui-whale/e78ac4406c68f4c1521b5d11143b516849d597aa/docs/%E6%91%86%E5%B0%BE%E5%B7%B4.gif" alt="摆尾巴" width="200"> <img src="https://raw.githubusercontent.com/lhh010/dsh-ui-whale/e78ac4406c68f4c1521b5d11143b516849d597aa/docs/%E6%91%86%E8%85%B9%E9%B3%8D.gif" alt="摆腹鳍" width="200">
...
dsh plugin --profile web add '@dsh-external/dsh-ui-whale@github:lhh010/dsh-ui-whale#v0.3.16'
...
> 1. 执行 `dsh plugin --profile web add '@dsh-external/dsh-ui-whale@github:lhh010/dsh-ui-whale#v0.3.16'`（首次可能被 pnpm 11 拦截 node-pty 构建脚本而失败）
...
| `v0.3.16`（当前版本） | `dsh-v0.1.2-alpha.1`~`alpha.5`、`rc.1`、`0.1.3-alpha.1`~`0.1.5-alpha.1` | 声明支持 0.1.5-alpha.1（npm 已发布，钉版本实机验证；0.1.5 改动在会话格式 V3 / ctx.agent 移除 / 宿主 bundle 服务路由 `/plugins/??`，client 插件面零代码差异；typecheck/build/单测全绿，启动清单确认加载） |
...
> git 依赖方式固定 tag（公开镜像，推荐）：`pnpm add '@dsh-external/dsh-ui-whale@github:lhh010/dsh-ui-whale#v0.3.16'`（或 `github:lhh010/dsh-ui-whale`；历史版本：0810/0811 用户用 `#v0.3.3`，0806~0809 用户用 `#v0.3.2`，0805 用户用 `#v0.1.0`）。
