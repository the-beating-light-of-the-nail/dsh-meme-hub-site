...
> 1. 执行 `dsh plugin --profile web add '@dsh-external/dsh-ui-whale@github:lhh010/dsh-ui-whale#v0.3.10'`（首次可能被 pnpm 11 拦截 node-pty 构建脚本而失败）
...
| `v0.3.10` | `dsh-v0.1.2-alpha.1`~`alpha.3` | 当前版本：更新提示词补「按 DSH 版本选 tag」路由说明与排查指引 |
...
> git 依赖方式固定 tag（公开镜像，推荐）：`pnpm add '@dsh-external/dsh-ui-whale@github:lhh010/dsh-ui-whale#v0.3.10'`（或 `github:lhh010/dsh-ui-whale`；历史版本：0810/0811 用户用 `#v0.3.3`，0806~0809 用户用 `#v0.3.2`，0805 用户用 `#v0.1.0`）。
...
![dsh-ui-whale 完整演示](https://raw.githubusercontent.com/lhh010/dsh-ui-whale/31fda0e543bffb04227d60f8608508360496cc91/docs/dsh-ui-whale-demo.gif)

各动作 GIF：

<img src="https://raw.githubusercontent.com/lhh010/dsh-ui-whale/31fda0e543bffb04227d60f8608508360496cc91/docs/%E7%9C%A8%E7%9C%BC.gif" alt="眨眼" width="200"> <img src="https://raw.githubusercontent.com/lhh010/dsh-ui-whale/31fda0e543bffb04227d60f8608508360496cc91/docs/%E6%91%86%E5%B0%BE%E5%B7%B4.gif" alt="摆尾巴" width="200"> <img src="https://raw.githubusercontent.com/lhh010/dsh-ui-whale/31fda0e543bffb04227d60f8608508360496cc91/docs/%E6%91%86%E8%85%B9%E9%B3%8D.gif" alt="摆腹鳍" width="200">
