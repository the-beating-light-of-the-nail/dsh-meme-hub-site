...
![Plugins](https://img.shields.io/badge/plugins-1815-facc15?style=flat-square)
...
![DSH Web UI 里的插件商店 Store 标签页](https://raw.githubusercontent.com/whyihaveyou/dsh-suite/e71c9be46436cdf4676003ee5f1dbe9c91616458/site/assets/store-tab.png)
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 6677 | 🟢 ok | DSH Web UI 插件与皮肤合集：任务板、Git 面板等 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3221 | 🟢 ok | 侧边栏完整工作台：文件渲染/终端/Git/子代理 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1879 | ⚪ unknown | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 851 | 🟢 ok | 给纯文本模型加视觉：图片问答、长截图 OCR、UI 还原 |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 113 | 🟢 ok | 把 Claude Code 的 UltraCode 模式带给 DSH，多 Agent 调度可治理 |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 109 | 🟢 ok | 对话回退：回滚会话与工作区状态 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 252 | ⚪ unknown | Claude Managed Agents API 的开源自托管平台（Cloudflare Workers） |
...
| [Hypr-Agent-Protal](https://github.com/gfhdhytghd/Hypr-Agent-Protal) | 5 | ⚪ unknown | Hyprland 的 Computer Use MCP |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 309 | 🟢 ok | Mnemon 三层记忆体深度集成 |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 42 | ⚪ unknown | OpenMAIC：课堂/幻灯片/交互式组件 |
...
| [dsh-scholar](https://github.com/lzszq/dsh-scholar) | 29 | 🟢 ok | dsh-scholar（文献相关） |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 83 | ⚪ unknown | 把 ego-lite 浏览器接入 DSH（给 Agent 用的 Chromium） |
...
| [modsearch](https://github.com/liustack/modsearch) | 334 | ⚪ unknown | DeepSeek Harness 的联网搜索插件。 |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 551 | 🟢 ok | Chrome 侧边栏扩展，让 DSH 操控浏览器。 |
...
| [dsh-expression](https://github.com/yyh-001/dsh-expression) | 71 | 🟢 ok | 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道 |
...
| [dsh-plugin-template](https://github.com/bugmaker2/dsh-plugin-template) | 93 | ⚪ unknown | dsh-plugin-template — DSH 插件（工具） |
...
| [dsh-soul-md](https://github.com/Scorp1o117/dsh-soul-md) | 5 | 🟢 ok | dsh-soul-md — DSH 插件（工具） |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 73 | 🟢 ok | 通过 ChatGPT OAuth 在 DeepSeek Harness 中使用 OpenAI Codex 模型。 |
...
| [dsh-prompt-enhancer](https://github.com/Fishsb/dsh-prompt-enhancer) | 62 | ⚪ unknown | DeepSeek Harness DSH 提示词增强插件：✨ 一键优化草稿 |
...
| [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) | 33 | 🟢 ok | dsh-codex-subscription — DSH 插件（工具） |
| [dsh-sticky-note](https://github.com/Meredith2328/dsh-sticky-note) | 34 | 🟢 ok | DSH 便签插件：随手记点子/感想/TODO，Markdown 预览 + 快捷键 + 历史归档，存储路径可配置 |
...
| [MuseAI](https://github.com/yejiming/MuseAI) | 633 | ⚪ unknown | 创建你的 AI 角色，进入你的故事世界。和角色聊天、冒险、穿书，让每一次互动都留下羁绊（支持 DeepSeek Harness 插件，欢迎使用） |
...
| [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) | 39 | ⚪ unknown | 让 DeepSeek Harness 变成服务器级多租户平台：远程访问 + 自动 HTTPS、子用户权限与配额、沙盒强制、加密认证与审计日志。 |
...
| [upstream-radar](https://github.com/MicroMilo/upstream-radar) | 9 | ⚪ unknown | 上游雷达：持续监控 DSH 插件的漏洞与破坏性变更影响。 |
...
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 391 | 🟢 ok | AnySearch 联网搜索接入：给 DSH 配上 AnySearch 的搜索 provider 和进阶搜索工具。 |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 506 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 3821 | ⚪ unknown | 两段式 Agent 预设：先用精简配置快速启动，再切换到完整 Standard 工具集，兼顾启动速度与全功能。 |
...
| [dsh-office](https://github.com/omdsh-dev/dsh-office) | 18 | 🟢 ok | 办公三件套！Office document tools for DeepSeek Harness (dsh): generate, read, and edit spreadsheets (.xlsx), PDFs, and presentations (.… |
...
| [deepseek-harness-for-vscode](https://github.com/skymecode/deepseek-harness-for-vscode) | 134 | ⚪ unknown | deepseek-harness 的 VS Code 社区扩展。 |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 107 | ⚪ unknown | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
| [dsh-better-edit](https://github.com/Rianico/dsh-better-edit) | 21 | 🟢 ok | Hash-anchored read/edit/batch_edit/undo_last_edit tools for DeepSeek Harness (dsh) — dsh port of pi-hashline-edit-lsz |
...
| [Deepseek-Harness-for-VS-Code](https://github.com/Vithrive/Deepseek-Harness-for-VS-Code) | 13 | ⚪ unknown | untranslated |
...
| [dsh-win32](https://github.com/sjh9714/dsh-win32) | 29 | 🟢 ok | untranslated |
...
| [DSH-Think-zh](https://github.com/Len7183/DSH-Think-zh) | 16 | ⚪ unknown | untranslated |
| [dsh-anchored-standard](https://github.com/Jungod1121/dsh-anchored-standard) | 25 | ⚪ unknown | untranslated |
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 349 | 🟢 ok | untranslated |
...
| [amadeus-for-dsh](https://github.com/yyxcnasd/amadeus-for-dsh) | 21 | ⚪ unknown | untranslated |
...
| [deepseek-harness-auth](https://github.com/taichuy/deepseek-harness-auth) | 24 | 🟢 ok | untranslated |
...
| [dsh-voice-ai-girlfriend](https://github.com/beiyege-01/dsh-voice-ai-girlfriend) | 62 | ⚪ unknown | untranslated |
...
| [dsh-trading](https://github.com/maddogfinance/dsh-trading) | 26 | ⚪ unknown | untranslated |
| [dsh-rust-sdk](https://github.com/42ch-dev/dsh-rust-sdk) | 7 | ⚪ unknown | untranslated |
...
| [webdsh](https://github.com/futrime/webdsh) | 29 | ⚪ unknown | untranslated |
| [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine) | 228 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
...
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 71 | ⚪ unknown | untranslated |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 233 | 🟢 ok | untranslated |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 163 | ⚪ unknown | untranslated |
...
| [dsh-oil-creator](https://github.com/oil-oil/dsh-oil-creator) | 173 | ⚪ unknown | untranslated |
...
| [custom-first-control-prompt](https://github.com/WM-CODER/custom-first-control-prompt) | 59 | ⚪ unknown | untranslated |
...
| [dsh-ros2](https://github.com/StvLi/dsh-ros2) | 17 | 🟢 ok | untranslated |
...
| [dsh-secure-audit](https://github.com/PensiveFei/dsh-secure-audit) | 83 | ⚪ unknown | untranslated |
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 322 | ⚪ unknown | untranslated |
...
| [dsh-portable](https://github.com/sqs404/dsh-portable) | 16 | ⚪ unknown | untranslated |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 70 | ⚪ unknown | untranslated |
...
| [dsh-automation](https://github.com/MichengAI/dsh-automation) | 13 | 🟢 ok | untranslated |
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 813 | ⚪ unknown | untranslated |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 40 | 🟢 ok | untranslated |
| [dsh-otel](https://github.com/tma1-ai/dsh-otel) | 9 | 🟢 ok | untranslated |
| [DSH-Creator](https://github.com/Jackywxsz/DSH-Creator) | 65 | ⚪ unknown | untranslated |
| [dsh-fund-research](https://github.com/PerryLink/dsh-fund-research) | 17 | 🟢 ok | untranslated |
| [dsh-yolo](https://github.com/hanshanyike/dsh-yolo) | 29 | ⚪ unknown | untranslated |
| [dsh-emacs](https://github.com/vritser/dsh-emacs) | 14 | ⚪ unknown | untranslated |
| [dsh-smart-charts](https://github.com/hherosoul/dsh-smart-charts) | 11 | ⚪ unknown | untranslated |
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 813 | ⚪ unknown | untranslated |
| [dsh-diagram](https://github.com/hanzhangzzz/dsh-diagram) | 9 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
| [@xxxyz/dsh-mcp-manager](https://github.com/xxxyz/DeepSeekHarness-MCP-Manager) | 8 | ⚪ unknown (作者自报实测通过（Windows + npx 通道，2026-08-27）) | DSH 双管理器——MCP 服务管理（设置页新增/编辑/启停/重启/删除、JSON 导入导出、4 个 mcp_manager_* 模型工具、带闸门的本地 HTTP API）+ Skills 技能管理（启停面板、持久化、HMR 即时生效）。 |
| [dsh-data-quality](https://github.com/PerryLink/dsh-data-quality) | 10 | 🟢 ok | untranslated |
...
| [dsh-plugins-raincode](https://github.com/rainforest888/dsh-plugins-raincode) | 3 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | dsh-plugins-raincode — DSH 插件（技能） |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 114 | 🟢 ok | Superpowers 技能包移植版：TDD、调试、规划、协作等经典工作流技能，装进 DSH 直接用。 |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 108 | ⚪ unknown | 逆向技能全家桶（85 个 SKILL.md）：逆向工程、授权渗透和安全研究的工作流，打包成插件。 |
...
| [dsh-skills-mcp-manager](https://github.com/zebbkira/dsh-skills-mcp-manager) | 21 | ⚪ unknown | 面向 DeepSeek Harness Web GUI 的正式插件包：在设置页的「Web UI 插件」分组中新增一张「技能与 MCP」卡片，用于在浏览器里管理技能（skills）与 MCP 服务器。 |
...
| [dsh-skill-picker](https://github.com/a735624258/dsh-skill-picker) | 26 | 🟢 ok | untranslated |
...
| [SpecFusion](https://github.com/wxkingstar/SpecFusion) | 59 | ⚪ unknown | untranslated |
...
| [new-litigation-visualization](https://github.com/MiaoQichuan/new-litigation-visualization) | 50 | ⚪ unknown | untranslated |
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 245 | ⚪ unknown | untranslated |
| [dsh-codex-sync](https://github.com/Walvez/dsh-codex-sync) | 25 | 🟢 ok | untranslated |
| [dsh-run2skill](https://github.com/qkycir-123/dsh-run2skill) | 49 | ⚪ unknown | untranslated |
| [dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) | 37 | ⚪ unknown | untranslated |
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 245 | ⚪ unknown | untranslated |
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 36 | 🟢 ok | untranslated |
| [dsh-plugin-capabilities](https://github.com/qinyre/dsh-plugin-capabilities) | 11 | 🟢 ok | untranslated |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 105 | 🟢 ok | 选中批注：选文字→批注→随消息发送 |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 388 | 🟢 ok | 会话内联渲染交互式 UI 组件 |
| [dsh-input-history](https://github.com/lhh010/dsh-input-history) | 4 | ⚪ unknown | Ctrl+Up/Down 召回已发送消息 |
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 58 | ⚪ unknown | 对话节点导航条（右缘节点串跳转） |
...
| [dsh-spotlight](https://github.com/0xsline/dsh-spotlight) | 19 | ⚪ unknown | 键盘优先的命令面板 |
...
| [dsh-web-ui-notify](https://github.com/bill9109/dsh-web-ui-notify) | 24 | ⚪ unknown | DSH 桌面通知提醒 |
| [ex-setting](https://github.com/omdsh-dev/ex-setting) | 2 | ⚪ unknown | DSH 设置扩展 |
| [whale-girl](https://github.com/vlln/whale-girl) | 303 | 🟢 ok | QQ 宠物形态的桌面宠物插件 |
| [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) | 65 | 🟢 ok | 替换 DSH 状态显示的 web 插件。 |
...
| [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) | 57 | ⚪ unknown | DSH Web UI plugin: automatically sends "继续" (continue) when a request is interrupted by network errors or other non-human causes |
...
| [dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 13 | 🟢 ok | 发布前双重检查：拷问需求、测试实现、防翻车。 |
...
| [dsh-vault](https://github.com/Ox0400/dsh-vault) | 7 | 🟢 ok | 加密凭据保险库：AES-256-GCM + TOTP，模型工具加密存取密钥。 |
...
| [dsh-git-graph](https://github.com/1841220388zzzcccxxx-star/dsh-git-graph) | 15 | ⚪ unknown | Embedded git repository graph visualizer for the DeepSeek Harness Web GUI | 嵌入式 Git 仓库图谱可视化插件（提交历史图 / 分支过滤 / 文件 diff / VSCode 式未提… |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 140 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 配置后悔药：插件/皮肤/设置改动自动快照，可撤销、可回滚，带快照管理面板和快捷键。 |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | DSH Web UI 内置插件商店：浏览 dsh-suite 目录、搜索/筛选/排序、兼容徽章、一键安装——设置页插件区的 Store 标签页。 |
...
| [dsh-catppuccin](https://github.com/NoNameLeGo/dsh-catppuccin) | 26 | 🟢 ok | DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种风味一键切换 |
| [dsh-sidebar-qa](https://github.com/ChenRuoT/dsh-sidebar-qa) | 37 | ⚪ unknown | 一个基于DSH-better-sidebar的侧边栏提问tab，实现类codex的侧边提问或claude code的/btw功能 |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 158 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree (client-inject skin may need web restart)) | 滑动变祖器皮肤：滑块控制『梁圣等级』（自适应推理强度），梗图风 DSH 皮肤 |
...
| [dsh-dream-skin](https://github.com/RevolutionLA/dsh-dream-skin) | 135 | 🟢 ok | DeepSeek Harness 换肤 / 壁纸 / 主题包插件 (dsh-plugin) — 8 套 Mirage 主题、每用户强调色、壁纸2.0、主题包导入导出/分享链接、收藏与随机，纯原生 token 系统实现。 |
...
| [dsh-smooth-stream](https://github.com/Laplace-bit/dsh-smooth-stream) | 65 | 🟢 ok | 为 DeepSeek Harness Web UI 提供流畅流式渲染和丝滑滚动。 |
| [voyager](https://github.com/Nagi-ovo/voyager) | 19928 | ⚪ unknown | untranslated |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1056 | 🟢 ok | untranslated |
...
| [dsh-catppuccin-theme](https://github.com/NoNameLeGo/dsh-catppuccin-theme) | 26 | ⚪ unknown | untranslated |
| [Dsh-FileExplorer](https://github.com/bearllfleed/Dsh-FileExplorer) | 6 | ⚪ unknown | untranslated |
...
| [dsh-whale-musume](https://github.com/Sutera-Diffusus/dsh-whale-musume) | 49 | ⚪ unknown | untranslated |
...
| [dsh-client-ui-skin-denia](https://github.com/Ewnscat-ya/dsh-client-ui-skin-denia) | 33 | ⚪ unknown | untranslated |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1573 | ⚪ unknown | untranslated |
...
| [dsh-undo-savepoint](https://github.com/lire1131/dsh-undo-savepoint) | 140 | ⚪ unknown | untranslated |
| [dsh-code-review](https://github.com/CooStack/dsh-code-review) | 7 | ⚪ unknown | untranslated |
| [dsh-knowledge](https://github.com/Soren-ABT/dsh-knowledge) | 21 | ⚪ unknown | untranslated |
...
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 52 | ⚪ unknown | untranslated |
| [dsh-theme-endfield](https://github.com/ymh0000123/dsh-theme-endfield) | 68 | ⚪ unknown | untranslated |
...
| [DSH-Mobile](https://github.com/SimonMedy/DSH-Mobile) | 11 | 🟢 ok | untranslated |
| [dsh-coding-subscription-oauth](https://github.com/lninghaha/dsh-coding-subscription-oauth) | 16 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 33 | 🟢 ok | untranslated |
| [dsh-bloom-theme](https://github.com/webkubor/dsh-bloom-theme) | 19 | ⚪ unknown | untranslated |
| [dsh-android](https://github.com/ZSeven-W/dsh-android) | 131 | ⚪ unknown | untranslated |
...
| [dsh-history-tree](https://github.com/z953218350/dsh-history-tree) | 16 | ⚪ unknown | untranslated |
...
| [dsh-comfyui](https://github.com/fandc520/dsh-comfyui) | 41 | 🟢 ok | untranslated |
| [dsh-uiskin-theme](https://github.com/chouxiaohuai/dsh-uiskin-theme) | 21 | ⚪ unknown | untranslated |
...
| [dsh-filesnap](https://github.com/extracurricular-ai/dsh-filesnap) | 28 | 🟢 ok | untranslated |
| [dsh-minecraft-ui](https://github.com/TFboy1/dsh-minecraft-ui) | 12 | 🟢 ok | untranslated |
| [dsh-whale-widget-plus](https://github.com/louke6572/dsh-whale-widget-plus) | 10 | ⚪ unknown | untranslated |
...
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 109 | 🟢 ok | 对话回退：回滚会话与工作区状态 |
| [dsh-share](https://github.com/hellodigua/dsh-share) | 35 | 🟢 ok | DSH 对话分享插件 |
| [dsh-message-edit](https://github.com/Moeblack/dsh-message-edit) | 48 | 🟢 ok | 分支式消息编辑、reroll、版本时间线 |
| [dsh-context-doctor](https://github.com/Zhenyu98/dsh-context-doctor) | 26 | ⚪ unknown | 上下文注入审计：AGENTS.md/技能/tool schema token 成本 |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 268 | 🟢 ok | 跨会话长期记忆 + 后台自我进化（纯插件） |
...
| [dsh-sidechain](https://github.com/Buyi-wsgzg/dsh-sidechain) | 12 | ⚪ unknown | 侧会话插件：/side 持续性 + /btw 一次性 |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | 把 append-only 会话日志导出成人读的 Markdown / HTML，按来源分组渲染（系统提示 / 思维链 / 工具调用 / 子agent）。 |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 131 | 🟢 ok | 从 Claude Code/Codex/Reasonix 导入历史消息到 DSH。 |
...
| [dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) | 14 | 🟢 ok | dsh-claude-move — DSH 插件（会话） |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 68 | 🟢 ok | billion-context-dsh — DSH 插件（会话） |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 79 | 🟢 ok | dsh-memento — DSH 插件（会话） |
...
| [dsh-session-pin](https://github.com/PerryLink/dsh-session-pin) | 5 | 🟢 ok | dsh-session-pin — DSH 插件（会话） |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 69 | ⚪ unknown | Mneme——把记忆主权还给人的记忆插件：SQLite + 可人工编辑的 Markdown 双写，autoDream 在梦境中巩固记忆，106 个测试护航。 |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 243 | 🟢 ok | DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步 |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 129 | 🟢 ok | dsh-auto-review — DSH 插件（会话） |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1235 | 🟢 ok | 上下文洞察面板：Web 界面加一个 Context 标签页，直观看到模型上下文窗口里装了什么、怎么变化的。 |
| [dsh-sidechain](https://github.com/omdsh-dev/dsh-sidechain) | 12 | ⚪ unknown | DSH 侧会话插件：/side 持续性侧会话（Codex 风格）与 /btw 一次性侧问（Claude 风格）——在临时 fork 中运行、不写入主会话历史；Web UI 右侧链面板内嵌对话，主会话保持不变 |
...
| [blender](https://github.com/CheshireJCat/blender) | 22 | ⚪ unknown | Blender 3D 全流程：建模、重建、渲染、校验、导出一站式，聊天里指挥 Blender 干活。 |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 92 | 🟢 ok | 多 agent 时空记忆图谱：跨会话持久记忆。 |
...
| [dsh-browser](https://github.com/wqty123/dsh-browser) | 42 | 🟢 ok | 共享真实浏览器插件：多个 agent 共用一个浏览器。 |
...
| [dsh-files](https://github.com/taxueseek/dsh-files) | 30 | ⚪ unknown | 双面插件：会话隔离的文件上传（彩色卡片）+ 文档读取工具（text/PDF/DOCX/XLSX）。 |
...
| [dsh-delete-session](https://github.com/dream12347/dsh-delete-session) | 58 | ⚪ unknown | Delete DSH conversation sessions from a Settings panel/在设置面板中增加删除会话管理以便删除无用会话 |
...
| [dsh-web-mobile](https://github.com/mexiaosqwq/dsh-web-mobile) | 74 | 🟢 ok | DeepSeek Harness Web UI 移动端适配插件:窄屏下侧边栏变为 overlay 抽屉,会话独占全宽。 |
...
| [dsh-self-improved](https://github.com/madage/dsh-self-improved) | 10 | 🟢 ok | untranslated |
| [dsh-bottom-info-bar](https://github.com/songoao25/dsh-bottom-info-bar) | 27 | ⚪ unknown | untranslated |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11145 | ⚪ unknown | untranslated |
...
| [dsh-sandbox-escalation-fix](https://github.com/JUSTMONIKA2022/dsh-sandbox-escalation-fix) | 42 | ⚪ unknown | untranslated |
...
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 63 | ⚪ unknown | untranslated |
| [dsh-archive-manager](https://github.com/MichengAI/dsh-archive-manager) | 35 | 🟢 ok | untranslated |
| [dsh-rewind](https://github.com/SiriLee/dsh-rewind) | 29 | 🟢 ok | untranslated |
| [dsh-Mmem](https://github.com/mianyoubiaoqing/dsh-Mmem) | 8 | ⚪ unknown | untranslated |
| [dsh-strata](https://github.com/jsdvjx/dsh-strata) | 89 | 🟢 ok | untranslated |
| [dsh-capability-menu](https://github.com/PKUfudawei/dsh-capability-menu) | 83 | ⚪ unknown | untranslated |
| [dsh-talk-map](https://github.com/Tasihi89/dsh-talk-map) | 72 | ⚪ unknown | untranslated |
...
| [dsh-ui-usage-billing](https://github.com/kenz1117/dsh-ui-usage-billing) | 26 | ⚪ unknown | untranslated |
| [distill-kura](https://github.com/lna-lab/distill-kura) | 30 | ⚪ unknown | untranslated |
...
| [dsh-maze](https://github.com/lamost423/dsh-maze) | 62 | 🟢 ok | untranslated |
...
| [dsh-sandbox-escalation-fix](https://github.com/HakureiMonika/dsh-sandbox-escalation-fix) | 42 | ⚪ unknown | untranslated |
| [dsh-mcp-manager-ui](https://github.com/Imzl-zl/dsh-mcp-manager-ui) | 12 | ⚪ unknown | untranslated |
| [dsh-archive-manager](https://github.com/z953218350/dsh-archive-manager) | 9 | 🟢 ok | untranslated |
...
| [modlens](https://github.com/liustack/modlens) | 3829 | 🟢 ok | DeepSeek Harness 首个视觉插件，纯文本模型看图。 |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1133 | ⚪ unknown | 为纯文本模型看图设计的视觉工具箱与技能：多图理解、图片问答、UI 还原、GUI 自动化。 |
...
| [dsh-mcp-manager](https://github.com/hyqhyq3/dsh-mcp-manager) | 12 | ⚪ unknown | dsh-mcp-manager — DSH 插件（模型） |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 192 | ⚪ unknown | Token 记账：对账 New API 与 Sub2API 中转站账单。 |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 136 | 🟢 ok | Command Code 的 LLM provider（非官方）：实时模型目录、推理强度支持，Models 页有卡片。 |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 309 | 🟢 ok | 把 ChatGPT(Codex)、Claude、Grok(X Premium) 的订阅当 DSH 的模型 provider 用。 |
...
| [dsh-reasoning-effort](https://github.com/HanaAyane/dsh-reasoning-effort) | 124 | 🟢 ok | DSH适用的Codex风格的思考强度滑块，以及大肥鱼跑步滑块。Codex-style model and reasoning-effort slider for DeepSeek Harness |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 590 | ⚪ unknown | untranslated |
| [dsh-plugin-writing-guard](https://github.com/xmutfyh/dsh-plugin-writing-guard) | 29 | 🟢 ok | untranslated |
...
| [dsh-wechat](https://github.com/pan17/dsh-wechat) | 7 | ⚪ unknown | untranslated |
...
| [dsh-crew](https://github.com/ZSeven-W/dsh-crew) | 125 | 🟢 ok | untranslated |
...
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 43 | ⚪ unknown | untranslated |
...
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 293 | 🟢 ok | untranslated |
| [dsh-mmx-bridge](https://github.com/welsione/dsh-mmx-bridge) | 10 | ⚪ unknown | untranslated |
| [dsh-computer-use](https://github.com/988hj7tczd-oss/dsh-computer-use) | 20 | ⚪ unknown | untranslated |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1008 | ⚪ unknown | untranslated |
...
| [dsh-with-chatgpt](https://github.com/BeforeWave/dsh-with-chatgpt) | 40 | ⚪ unknown | untranslated |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1047 | ⚪ unknown (watchlist 占位→plugins；dsh.client 声明完整) | 给纯文本 DSH 智能体装上眼睛：内置免 key 免费视觉链 + 11 个像素级视觉工具，一条命令安装，无需 Python。 |
| [dsh-antigravity](https://github.com/LiZhenNet/dsh-antigravity) | 12 | ⚪ unknown | untranslated |
...
| [dsh-voice-scribe](https://github.com/PensiveFei/dsh-voice-scribe) | 31 | ⚪ unknown | untranslated |
| [opencode2dsh](https://github.com/FishBottle7/opencode2dsh) | 17 | ⚪ unknown | untranslated |
| [dsh-better-reasoning-effort](https://github.com/HaoyueQin/dsh-better-reasoning-effort) | 14 | ⚪ unknown | untranslated |
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 260 | ⚪ unknown | untranslated |
...
| [dsh-auto-approve](https://github.com/Jiao-XXX/dsh-auto-approve) | 12 | 🟢 ok | 保守自动批准档：介于工作区写与完全放开之间的权限档，危险/不确定操作仍转人工。 |
...
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3596 | 🟢 ok | 把 DSH 的 fs/shell 提供者换成 mirage 虚拟工作区：文件工具与 shell 命令作用于挂载的资源（RAM/磁盘/S3/Redis/Postgres/Slack/Gmail/Notion）而非宿主磁盘。 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6459 | ⚪ unknown | 带记忆、人格与自主性的个人 AI 智能体 |
| [exo](https://github.com/exoharness/exo) | 912 | ⚪ unknown | 可递归自编辑自身的 agent+harness 架构 |
| [synergy](https://github.com/SII-Holos/synergy) | 549 | ⚪ unknown | 面向 Open Agentic Web 的通用智能体 |
| [ccteam](https://github.com/firstintent/ccteam) | 385 | ⚪ unknown | 把 Claude Code/Codex/Grok/Kimi 编成团队，Telegram/飞书指挥 |
...
| [distill](https://github.com/LoserFox/distill) | 25 | ⚪ unknown | 自动对话蒸馏：后台 subagent 反省 + 技能更新 |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1269 | 🟢 ok | AgentTeams 插件 |
...
| [deepseek-harness-fnos](https://github.com/techysy/deepseek-harness-fnos) | 27 | ⚪ unknown | DeepSeek Harness (DeepSeek 官方 agent 浏览器 UI) fnOS 应用 — 本地常驻服务, 官方统一网关接入 |
| [dsh-agent-arcade](https://github.com/fff122/dsh-agent-arcade) | 1 | ⚪ unknown | dsh-agent-arcade — DSH 插件（编排） |
| [dsh-skillport](https://github.com/Jesse-njx/dsh-skillport) | 5 | ⚪ unknown | dsh-skillport — DSH 插件（编排） |
...
| [dsh-file-review](https://github.com/left0ver/dsh-file-review) | 32 | 🟢 ok | 改完就能审：agent 刚动过的文件直接看 diff，不用离开 DSH Web。 |
| [embedded-workbench](https://github.com/AmethystLuna/embedded-workbench) | 6 | ⚪ unknown | 嵌入式 C/C++ AI 工程插件：固件技能（FreeRTOS、Keil、HardFault 调试）。 |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3123 | ⚪ unknown | 通用技能调度器：自动挑选最合适的本地 Skill 并编排整个 Harness 工作流，不用手动指定用哪个技能。 |
...
| [sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | 98 | ⚪ unknown | 88 个可直接安装的 Agent 技能：覆盖研究与增长工作流，带 npm CLI 分发。 |
...
| [dsh-agent-team-gui](https://github.com/toolclub/dsh-agent-team-gui) | 162 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
...
| [dsh_workflow](https://github.com/omdsh-dev/dsh_workflow) | 113 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
...
| [dsh-deepread](https://github.com/xiehuan123/dsh-deepread) | 44 | 🟢 ok | untranslated |
...
| [dsh-fate-spectrum](https://github.com/EchoUser005/dsh-fate-spectrum) | 9 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
...
| [dsh-quant](https://github.com/pengpengyi92/dsh-quant) | 27 | 🟢 ok | untranslated |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 73 | ⚪ unknown | untranslated |
...
| [dsh-evolve-modes](https://github.com/GraySilver/dsh-evolve-modes) | 201 | ⚪ unknown | untranslated |
...
| [dsh-agency-agents](https://github.com/MichengAI/dsh-agency-agents) | 27 | ⚪ unknown | untranslated |
...
| [dsh-router-standard](https://github.com/yjh051108/dsh-router-standard) | 365 | ⚪ unknown | untranslated |
...
| [dsh-raw-html](https://github.com/plolpl789/dsh-raw-html) | 48 | ⚪ unknown | untranslated |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 158 | ⚪ unknown | untranslated |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5403 | ⚪ unknown | untranslated |
| [sofagent](https://github.com/KongFangXun/sofagent) | 41 | ⚪ unknown | untranslated |
| [dsh-ultramath](https://github.com/Andiii208/dsh-ultramath) | 11 | 🟢 ok | untranslated |
| [dsh-Visual-Workflow](https://github.com/GZX2211/dsh-Visual-Workflow) | 14 | ⚪ unknown | untranslated |
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 76 | ⚪ unknown | untranslated |
| [dsh-plugin-developer-skill](https://github.com/liangdabiao/dsh-plugin-developer-skill) | 12 | ⚪ unknown | untranslated |
...
| [deepseek-harness-acp](https://github.com/openma-ai/deepseek-harness-acp) | 21 | ⚪ unknown | ACP 服务器实现：让外部工具通过 Agent Client Protocol 驱动 DSH。 |
| [dsh-quota-panel](https://github.com/brittanistrehlowll-oss/dsh-quota-panel) | 4 | 🟢 ok | Provider 配额/余额角落面板：服务端凭证代理 + 配置驱动的显示。 |
| [pi2dsh](https://github.com/weijiafu14/pi2dsh) | 179 | 🟢 ok | Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plugins. 打通 Pi 与 DSH 生… |
...
| [dsh-easyssh](https://github.com/chenw2759-wq/dsh-easyssh) | 32 | ⚪ unknown | 用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。 |
| [dsh-plugin-deepseek-balance](https://github.com/fishxcode/dsh-plugin-deepseek-balance) | 2 | ⚪ unknown | Web 客户端实时显示 DeepSeek API 余额。 |
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 51 | 🟢 ok | 远程接入助手：/remote 命令 + 设置页直接打印 SSH 隧道/反向隧道命令，远程工作区一键连。 |
...
| [dsh-multi-user-gateway](https://github.com/AnkoCD/dsh-multi-user-gateway) | 22 | ⚪ unknown | 服务器端部署：DeepSeek Harness Web 多用户网关（登录门户 / 每用户实例隔离 / 交付文件抽屉）。部署于远程服务器，用户通过浏览器访问，非本机工具。 |
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 53 | ⚪ unknown | 安卓伴侣应用：聊天、目标、审批与通知，手机随时遥控 DSH。 |
...
| [dsh-server-deployment](https://github.com/AnkoCD/dsh-server-deployment) | 22 | ⚪ unknown | 服务器端部署：DeepSeek Harness Web 多用户网关（登录门户 / 每用户实例隔离 / 交付文件抽屉）。部署于远程服务器，用户通过浏览器访问，非本机工具。 |
...
| [dsh-IDE](https://github.com/chenw2759-wq/dsh-IDE) | 32 | ⚪ unknown | 这是一个ssh前端程序，可以让UI体现类似lab的功能！用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。 |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 890 | 🟢 ok | untranslated |
...
| [dsh-usage](https://github.com/Aisland-SJL/dsh-usage) | 82 | 🟢 ok | untranslated |
...
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 186 | 🟢 ok | untranslated |
...
| [dsh-remote-web-gateway](https://github.com/summer1238/dsh-remote-web-gateway) | 167 | 🟢 ok | untranslated |
| [dsh-web-startup-auth](https://github.com/GDWhisper/dsh-web-startup-auth) | 16 | 🟢 ok | untranslated |
...
| [ds-harness-remote](https://github.com/liguobao/ds-harness-remote) | 150 | 🟢 ok | untranslated |
| [dsh-remote](https://github.com/SCSpotato/dsh-remote) | 16 | 🟢 ok | untranslated |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3153 | ⚪ unknown | 一键安装+切换 Claude Code/Codex/Kimi/Qwen 等 20+ 编码智能体 |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 973 | ⚪ unknown | DSH 生态精选：插件、工具与基建 |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 252 | 🟢 ok | DSH 终端 UI（TUI） |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 597 | ⚪ unknown | 2005 年中文站点风格侧栏广告插件（恶搞） |
...
| [dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil) | 158 | 🟢 ok | 把 DSH 接进 OpenPencil 设计工具：Agent 可以在设计稿上做预览和编辑，边聊边改设计。 |
...
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 248 | 🟢 ok | 对话内生成式 UI：把交互式 HTML 卡片画进会话 |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 307 | ⚪ unknown | 双语 DSH 插件生态完整列表 |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 190 | 🟢 ok | 基于 WebView2 的 DSH 启动器 |
...
| [dsh-lark](https://github.com/omdsh-dev/dsh-lark) | 49 | ⚪ unknown | Lark/Feishu IM bot channel for DeepSeek Harness: chats drive agents, replies and approvals return as messages and cards | 飞书 Deep… |
...
| [dsh-notifier](https://github.com/THEWOLFWALKER/dsh-notifier) | 82 | 🟢 ok | untranslated |
...
| [dsh-meow-smooth](https://github.com/Phant0Meow/dsh-meow-smooth) | 34 | ⚪ unknown | untranslated |
...
> 徽章含义：🟢 兼容 · 🔴 不兼容 · ⚪ 未实测 · ⚫ 弃坑。
> 共 1815 个条目，按分类分表、类内按 ⭐ 降序。收录 / 字段词典见 [docs/catalog-schema.md](docs/catalog-schema.md)。
<!-- CATALOG:END -->
