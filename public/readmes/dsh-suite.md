...
![Plugins](https://img.shields.io/badge/plugins-1827-facc15?style=flat-square)
...
![DSH Web UI 里的插件商店 Store 标签页](https://raw.githubusercontent.com/whyihaveyou/dsh-suite/bbe76dfd433288ebafe30f9a45410ee085c5ba28/site/assets/store-tab.png)
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 6802 | 🟢 ok | DSH Web UI 插件与皮肤合集：任务板、Git 面板等 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3310 | 🟢 ok | 侧边栏完整工作台：文件渲染/终端/Git/子代理 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1908 | ⚪ unknown | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 850 | 🟢 ok | 给纯文本模型加视觉：图片问答、长截图 OCR、UI 还原 |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 114 | 🟢 ok | 把 Claude Code 的 UltraCode 模式带给 DSH，多 Agent 调度可治理 |
| [dsh-turn-rewind](https://github.com/Anionex/dsh-turn-rewind) | 111 | 🟢 ok | 对话回退：回滚会话与工作区状态 |
| [mstar-harness](https://github.com/btspoony/mstar-harness) | 57 | ⚪ unknown | Skill 驱动的 Harness/Loop 工程工作流插件 |
...
| [themes (皮肤中心)](https://github.com/whyihaveyou/dsh-themes) | 10 | 🟢 ok | 皮肤中心：151 款昼夜成对皮肤一包打尽——网格预览、搜索、一键试穿，支持收藏、最近试穿与随机换肤。 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 255 | ⚪ unknown | Claude Managed Agents API 的开源自托管平台（Cloudflare Workers） |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 323 | 🟢 ok | Mnemon 三层记忆体深度集成 |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 47 | ⚪ unknown | OpenMAIC：课堂/幻灯片/交互式组件 |
...
| [dsh-scholar](https://github.com/lzszq/dsh-scholar) | 34 | 🟢 ok | dsh-scholar（文献相关） |
| [dsh-ssh](https://github.com/UynajGI/dsh-ssh) | 9 | 🟢 ok | SSH 远程执行：ProxyJump 链、SFTP |
| [dsh-tool-search](https://github.com/vibeinging/dsh-tool-search) | 3 | 🟢 ok | 按 agent 按需工具发现与渐进 schema 披露 |
| [dsh-webbridge](https://github.com/bill9109/dsh-webbridge) | 4 | ⚪ unknown | DSH 结合 Kimi WebBridge |
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 86 | ⚪ unknown | 把 ego-lite 浏览器接入 DSH（给 Agent 用的 Chromium） |
...
| [modsearch](https://github.com/liustack/modsearch) | 348 | ⚪ unknown | DeepSeek Harness 的联网搜索插件。 |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 566 | 🟢 ok | Chrome 侧边栏扩展，让 DSH 操控浏览器。 |
...
| [codex-plugin-dsh](https://github.com/wingoo/codex-plugin-dsh) | 8 | ⚪ unknown | codex-plugin-dsh — DSH 插件（工具） |
...
| [dsh-plugin-template](https://github.com/bugmaker2/dsh-plugin-template) | 107 | ⚪ unknown | dsh-plugin-template — DSH 插件（工具） |
...
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 79 | 🟢 ok | 通过 ChatGPT OAuth 在 DeepSeek Harness 中使用 OpenAI Codex 模型。 |
...
| [dsh-prompt-enhancer](https://github.com/Fishsb/dsh-prompt-enhancer) | 64 | ⚪ unknown | DeepSeek Harness DSH 提示词增强插件：✨ 一键优化草稿 |
...
| [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) | 40 | 🟢 ok | dsh-codex-subscription — DSH 插件（工具） |
...
| [dsh-plugin-knowledge-graph](https://github.com/Luke-Yong/dsh-plugin-knowledge-graph) | 4 | ⚪ unknown | 代码知识图谱：read_graph 工具基于代码库知识图谱回答结构性问题。 |
...
| [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) | 44 | ⚪ unknown | 让 DeepSeek Harness 变成服务器级多租户平台：远程访问 + 自动 HTTPS、子用户权限与配额、沙盒强制、加密认证与审计日志。 |
...
| [upstream-radar](https://github.com/MicroMilo/upstream-radar) | 10 | ⚪ unknown | 上游雷达：持续监控 DSH 插件的漏洞与破坏性变更影响。 |
...
| [dsh-tool-search](https://github.com/Letter2025/dsh-tool-search) | 6 | 🟢 ok | 工具搜索与瘦身：Hermes 式渐进披露——按需搜索、描述、调用长尾工具。 |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 534 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-qqbot](https://github.com/tencent-connect/dsh-qqbot) | 84 | 🟢 ok | 让 QQ 机器人接入 DeepSeek Harness（dsh）的官方插件 |
...
| [dsh-plugin](https://github.com/Tabbit-Browser/dsh-plugin) | 99 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | 让 DSH 通过插件控制 Tabbit 浏览器：安装后 agent 可以驱动 Tabbit 做浏览器操作。 |
...
| [dsh-auto-mode](https://github.com/NanmiCoder/dsh-auto-mode) | 145 | 🟢 ok | 安全的自动授权：在「每次都要点批准」和「无脑全放开」之间加一档，按规则自动放行常规操作。 |
...
| [dsh-web-mobile-fix](https://github.com/AcidGr/dsh-web-mobile-fix) | 6 | ⚪ unknown | DSH Web 移动端修复增强插件。 |
...
| [adhdgofly-dsh-ext](https://github.com/zuoguyoupan2023/adhdgofly-dsh-ext) | 5 | 🟢 ok | 词性高亮：名词绿、动词红，让 AI 文本一眼看清结构。 |
...
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 123 | ⚪ unknown | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [deepseek-harness-zh_pro](https://github.com/magian1127/deepseek-harness-zh_pro) | 25 | ⚪ unknown | untranslated |
...
| [dsh-backup](https://github.com/xiaoyuyu6420/dsh-backup) | 15 | 🟢 ok | untranslated |
...
| [dsh-anchored-standard](https://github.com/Jungod1121/dsh-anchored-standard) | 24 | ⚪ unknown | untranslated |
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 369 | 🟢 ok | untranslated |
...
| [dsh-voice-ai-girlfriend](https://github.com/beiyege-01/dsh-voice-ai-girlfriend) | 72 | ⚪ unknown | untranslated |
...
| [dsh-trading](https://github.com/maddogfinance/dsh-trading) | 28 | ⚪ unknown | untranslated |
...
| [dsh-ai4scholar](https://github.com/literaf/dsh-ai4scholar) | 18 | 🟢 ok | untranslated |
| [webdsh](https://github.com/futrime/webdsh) | 30 | ⚪ unknown | untranslated |
| [dsh-wallpaper-engine](https://github.com/elysia395/dsh-wallpaper-engine) | 235 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
| [deepseek-harness-sdr-plugin](https://github.com/Xuxchloris/deepseek-harness-sdr-plugin) | 27 | ⚪ unknown | untranslated |
| [dsh-plugin-gather](https://github.com/lilwhich/dsh-plugin-gather) | 10 | ⚪ unknown | untranslated |
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 75 | ⚪ unknown | untranslated |
| [oss-prompt-optimizer](https://github.com/seven282/oss-prompt-optimizer) | 12 | 🟢 ok | untranslated |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 264 | 🟢 ok | untranslated |
...
| [dsh-taskboard](https://github.com/cloader/dsh-taskboard) | 33 | ⚪ unknown | untranslated |
| [dsh-omi-voice](https://github.com/PolinniZhong/dsh-omi-voice) | 74 | ⚪ unknown | untranslated |
| [forgeax-dsh-game-plugin](https://github.com/ForgeaX-Games/forgeax-dsh-game-plugin) | 6 | ⚪ unknown | untranslated |
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 215 | ⚪ unknown | untranslated |
...
| [dsh-oil-creator](https://github.com/oil-oil/dsh-oil-creator) | 177 | ⚪ unknown | untranslated |
...
| [dsh-tether](https://github.com/zexadev/dsh-tether) | 41 | ⚪ unknown | untranslated |
| [dsh-personal-center](https://github.com/PolinniZhong/dsh-personal-center) | 38 | ⚪ unknown | untranslated |
| [dsh-server-login](https://github.com/pointer-a/dsh-server-login) | 16 | ⚪ unknown | untranslated |
...
| [dsh-secure-audit](https://github.com/PensiveFei/dsh-secure-audit) | 87 | ⚪ unknown | untranslated |
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 374 | ⚪ unknown | untranslated |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 78 | ⚪ unknown | untranslated |
...
| [dsh-automation](https://github.com/MichengAI/dsh-automation) | 15 | 🟢 ok | untranslated |
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 927 | ⚪ unknown | untranslated |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 46 | 🟢 ok | untranslated |
| [dsh-otel](https://github.com/tma1-ai/dsh-otel) | 9 | 🟢 ok | untranslated |
| [DSH-Creator](https://github.com/Jackywxsz/DSH-Creator) | 85 | ⚪ unknown | untranslated |
| [dsh-fund-research](https://github.com/PerryLink/dsh-fund-research) | 20 | 🟢 ok | untranslated |
| [dsh-yolo](https://github.com/hanshanyike/dsh-yolo) | 53 | ⚪ unknown | untranslated |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 927 | ⚪ unknown | untranslated |
...
| [unity-plugin](https://github.com/opdsh/unity-plugin) | 21 | ⚪ unknown | untranslated |
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 102 | 🟢 ok | untranslated |
| [dsh-tinyfish-search](https://github.com/maxwell-feng/dsh-tinyfish-search) | 12 | ⚪ unknown | untranslated |
| [dsh-mermaid](https://github.com/MrmoLabs/dsh-mermaid) | 10 | ⚪ unknown | untranslated |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 122 | 🟢 ok | Superpowers 技能包移植版：TDD、调试、规划、协作等经典工作流技能，装进 DSH 直接用。 |
...
| [dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) | 29 | 🟢 ok | untranslated |
...
| [minecraft-dev](https://github.com/sikadi233-hub/minecraft-dev) | 12 | 🟢 ok | untranslated |
...
| [new-litigation-visualization](https://github.com/MiaoQichuan/new-litigation-visualization) | 52 | ⚪ unknown | untranslated |
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 283 | ⚪ unknown | untranslated |
| [dsh-codex-sync](https://github.com/Walvez/dsh-codex-sync) | 25 | 🟢 ok | untranslated |
| [dsh-run2skill](https://github.com/qkycir-123/dsh-run2skill) | 65 | ⚪ unknown | untranslated |
| [dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) | 44 | ⚪ unknown | untranslated |
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 283 | ⚪ unknown | untranslated |
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 52 | 🟢 ok | untranslated |
...
| [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 402 | 🟢 ok | 会话内联渲染交互式 UI 组件 |
| [dsh-input-history](https://github.com/lhh010/dsh-input-history) | 4 | ⚪ unknown | Ctrl+Up/Down 召回已发送消息 |
| [dsh-navbar](https://github.com/vlln/dsh-navbar) | 57 | ⚪ unknown | 对话节点导航条（右缘节点串跳转） |
...
| [dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) | 24 | ⚪ unknown | 跨平台文件拖拽与原始路径插入 |
...
| [dsh-spotlight](https://github.com/0xsline/dsh-spotlight) | 20 | ⚪ unknown | 键盘优先的命令面板 |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 309 | 🟢 ok | QQ 宠物形态的桌面宠物插件 |
...
| [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) | 63 | ⚪ unknown | DSH Web UI plugin: automatically sends "继续" (continue) when a request is interrupted by network errors or other non-human causes |
...
| [dsh-doublecheck](https://github.com/PerryLink/dsh-doublecheck) | 14 | 🟢 ok | 发布前双重检查：拷问需求、测试实现、防翻车。 |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 143 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 配置后悔药：插件/皮肤/设置改动自动快照，可撤销、可回滚，带快照管理面板和快捷键。 |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | DSH Web UI 内置插件商店：浏览 dsh-suite 目录、搜索/筛选/排序、兼容徽章、一键安装——设置页插件区的 Store 标签页。 |
...
| [dsh-catppuccin](https://github.com/NoNameLeGo/dsh-catppuccin) | 29 | 🟢 ok | DeepSeek Harness Web GUI 的 Catppuccin 主题插件：Latte / Frappé / Macchiato / Mocha 四种风味一键切换 |
| [dsh-sidebar-qa](https://github.com/ChenRuoT/dsh-sidebar-qa) | 39 | ⚪ unknown | 一个基于DSH-better-sidebar的侧边栏提问tab，实现类codex的侧边提问或claude code的/btw功能 |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 160 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree (client-inject skin may need web restart)) | 滑动变祖器皮肤：滑块控制『梁圣等级』（自适应推理强度），梗图风 DSH 皮肤 |
...
| [dsh-dream-skin](https://github.com/RevolutionLA/dsh-dream-skin) | 140 | 🟢 ok | DeepSeek Harness 换肤 / 壁纸 / 主题包插件 (dsh-plugin) — 8 套 Mirage 主题、每用户强调色、壁纸2.0、主题包导入导出/分享链接、收藏与随机，纯原生 token 系统实现。 |
...
| [voyager](https://github.com/Nagi-ovo/voyager) | 19937 | ⚪ unknown | untranslated |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1094 | 🟢 ok | untranslated |
...
| [dsh-catppuccin-theme](https://github.com/NoNameLeGo/dsh-catppuccin-theme) | 29 | ⚪ unknown | untranslated |
...
| [dsh-plugin-uisfx](https://github.com/XanthanL/dsh-plugin-uisfx) | 5 | ⚪ unknown | untranslated |
...
| [dsh-joi-channel-theme](https://github.com/tpmoonchefryan/dsh-joi-channel-theme) | 16 | 🟢 ok | untranslated |
...
| [dsh-client-ui-custom](https://github.com/yoli-mi/dsh-client-ui-custom) | 25 | ⚪ unknown | untranslated |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1687 | ⚪ unknown | untranslated |
...
| [dsh-kimino-theme](https://github.com/niiang/dsh-kimino-theme) | 30 | ⚪ unknown | untranslated |
| [dsh-beauty-skins](https://github.com/XieRW/dsh-beauty-skins) | 101 | ⚪ unknown | untranslated |
| [open-sea-skin](https://github.com/d-dev0101/open-sea-skin) | 195 | 🟢 ok | untranslated |
...
| [dsh-prompt-optimize](https://github.com/1847123733/dsh-prompt-optimize) | 6 | ⚪ unknown | untranslated |
| [dsh-undo-savepoint](https://github.com/lire1131/dsh-undo-savepoint) | 143 | ⚪ unknown | untranslated |
| [dsh-code-review](https://github.com/CooStack/dsh-code-review) | 7 | ⚪ unknown | untranslated |
| [dsh-knowledge](https://github.com/Soren-ABT/dsh-knowledge) | 25 | ⚪ unknown | untranslated |
...
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 54 | ⚪ unknown | untranslated |
...
| [dsh-coding-subscription-oauth](https://github.com/lninghaha/dsh-coding-subscription-oauth) | 17 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 38 | 🟢 ok | untranslated |
| [dsh-bloom-theme](https://github.com/webkubor/dsh-bloom-theme) | 20 | ⚪ unknown | untranslated |
...
| [dsh-ui-tweaks](https://github.com/wlj521/dsh-ui-tweaks) | 15 | 🟢 ok | untranslated |
| [dsh-anchored-monitor](https://github.com/Aik358/dsh-anchored-monitor) | 11 | ⚪ unknown | untranslated |
| [dsh-history-tree](https://github.com/z953218350/dsh-history-tree) | 17 | ⚪ unknown | untranslated |
...
| [dsh-comfyui](https://github.com/fandc520/dsh-comfyui) | 46 | 🟢 ok | untranslated |
...
| [dsh-tavern-v2](https://github.com/chen731215-dev/dsh-tavern-v2) | 9 | ⚪ unknown | untranslated |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 277 | 🟢 ok | 跨会话长期记忆 + 后台自我进化（纯插件） |
...
| [dsh-conversation-share](https://github.com/bill9109/dsh-conversation-share) | 3 | ⚪ unknown | 分享任意段落对话 |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | 把 append-only 会话日志导出成人读的 Markdown / HTML，按来源分组渲染（系统提示 / 思维链 / 工具调用 / 子agent）。 |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 132 | 🟢 ok | 从 Claude Code/Codex/Reasonix 导入历史消息到 DSH。 |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 89 | 🟢 ok | dsh-memento — DSH 插件（会话） |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 80 | ⚪ unknown | Mneme——把记忆主权还给人的记忆插件：SQLite + 可人工编辑的 Markdown 双写，autoDream 在梦境中巩固记忆，106 个测试护航。 |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 251 | 🟢 ok | DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步 |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 132 | 🟢 ok | dsh-auto-review — DSH 插件（会话） |
...
| [dsh-background-agents](https://github.com/PerryLink/dsh-background-agents) | 9 | 🟢 ok | 后台长任务 agent：启动可续跑的子 agent，Web 界面实时看进度。 |
...
| [dsh-auto-memory](https://github.com/Aik358/dsh-auto-memory) | 45 | ⚪ unknown | DSH 自动记忆插件:三层记忆(用户级/项目笔记/每日日志)自动注入与检索、每日反思、可视化面板与设置页,支持继承其他 AI 工具的历史记忆。 |
...
| [dsh-context](https://github.com/bowenliang123/dsh-context) | 1269 | 🟢 ok | 上下文洞察面板：Web 界面加一个 Context 标签页，直观看到模型上下文窗口里装了什么、怎么变化的。 |
...
| [blender](https://github.com/CheshireJCat/blender) | 23 | ⚪ unknown | Blender 3D 全流程：建模、重建、渲染、校验、导出一站式，聊天里指挥 Blender 干活。 |
...
| [dsh-wanghong-handwritten-ppt](https://github.com/tjxj/dsh-wanghong-handwritten-ppt) | 4 | ⚪ unknown | 王虹学术手写风 PPT Skill for DeepSeek Harness · Notability-style HTML slides and PNG export |
...
| [dsh-btw](https://github.com/iyllyt/dsh-btw) | 8 | 🟢 ok | 个人很喜欢 Claude Code 的 /btw，于是为 DSH 做了复刻：共享当前上下文快速旁路提问，不中断主任务，也不写入主会话历史。 |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 111 | 🟢 ok | 多 agent 时空记忆图谱：跨会话持久记忆。 |
...
| [DSH-recall-plugin](https://github.com/limbo947/DSH-recall-plugin) | 29 | 🟢 ok | DSH 消息撤回插件：回到发送该消息时的状态 |
...
| [dsh-mcp-lens](https://github.com/labmimors/dsh-mcp-lens) | 7 | 🟢 ok | 缩减 DeepSeek Harness 的 MCP 上下文：将 1,000 个远程工具收进 2 个精确 Schema 接口，并附 V4 Flash 小规模成本实测。 |
| [dsh-subagent-admission](https://github.com/yha9806/dsh-subagent-admission) | 3 | ⚪ unknown | 共享生命周期准入协议与参考策略内核（面向子代理）。 |
| [dsh-browser](https://github.com/wqty123/dsh-browser) | 46 | 🟢 ok | 共享真实浏览器插件：多个 agent 共用一个浏览器。 |
...
| [dsh-files](https://github.com/taxueseek/dsh-files) | 31 | ⚪ unknown | 双面插件：会话隔离的文件上传（彩色卡片）+ 文档读取工具（text/PDF/DOCX/XLSX）。 |
...
| [dsh-web-mobile](https://github.com/mexiaosqwq/dsh-web-mobile) | 76 | 🟢 ok | DeepSeek Harness Web UI 移动端适配插件:窄屏下侧边栏变为 overlay 抽屉,会话独占全宽。 |
...
| [dsh-Remote](https://github.com/Blank-not-black/dsh-Remote) | 32 | 🟢 ok | untranslated |
...
| [dsh-bottom-info-bar](https://github.com/songoao25/dsh-bottom-info-bar) | 28 | ⚪ unknown | untranslated |
| [dsh-board](https://github.com/dfkai/dsh-board) | 8 | ⚪ unknown | untranslated |
| [dsh-web-remote](https://github.com/godchen520/dsh-web-remote) | 8 | ⚪ unknown | untranslated |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11178 | ⚪ unknown | untranslated |
...
| [dsh-trace-compare](https://github.com/lamost423/dsh-trace-compare) | 64 | 🟢 ok | 执行轨迹可视化：主干、失败支路、折返点与子代理支路画在同一根墙钟时间轴上；支持上传 1–2 个 session log 同轴对比，或在会话页签实时看迷宫生长。 |
| [dsh-sandbox-escalation-fix](https://github.com/JUSTMONIKA2022/dsh-sandbox-escalation-fix) | 45 | ⚪ unknown | untranslated |
| [dsh-nested-followups](https://github.com/sluminositys/dsh-nested-followups) | 19 | 🟢 ok | untranslated |
...
| [dsh-recall-unread](https://github.com/hg1048596-pixel/dsh-recall-unread) | 123 | ⚪ unknown | untranslated |
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 73 | ⚪ unknown | untranslated |
| [dsh-archive-manager](https://github.com/MichengAI/dsh-archive-manager) | 39 | 🟢 ok | untranslated |
| [dsh-rewind](https://github.com/SiriLee/dsh-rewind) | 35 | 🟢 ok | untranslated |
| [dsh-Mmem](https://github.com/mianyoubiaoqing/dsh-Mmem) | 8 | ⚪ unknown | untranslated |
| [dsh-strata](https://github.com/jsdvjx/dsh-strata) | 106 | 🟢 ok | untranslated |
| [dsh-capability-menu](https://github.com/PKUfudawei/dsh-capability-menu) | 84 | ⚪ unknown | untranslated |
| [dsh-talk-map](https://github.com/Tasihi89/dsh-talk-map) | 78 | ⚪ unknown | untranslated |
...
| [dsh-wallpaper_share](https://github.com/YRN-playmaker/dsh-wallpaper_share) | 27 | ⚪ unknown | untranslated |
...
| [dsh-ui-usage-billing](https://github.com/kenz1117/dsh-ui-usage-billing) | 28 | ⚪ unknown | untranslated |
| [distill-kura](https://github.com/lna-lab/distill-kura) | 41 | ⚪ unknown | untranslated |
| [StrataGate-AgentMemory](https://github.com/diqierjia/StrataGate-AgentMemory) | 21 | ⚪ unknown | untranslated |
| [dsh-layered-memory](https://github.com/JunNanLYS/dsh-layered-memory) | 11 | 🟢 ok | untranslated |
| [dsh-maze](https://github.com/lamost423/dsh-maze) | 64 | 🟢 ok | untranslated |
...
| [dsh-sandbox-escalation-fix](https://github.com/HakureiMonika/dsh-sandbox-escalation-fix) | 45 | ⚪ unknown | untranslated |
...
| [dsh-meow-cachebilling](https://github.com/Phant0Meow/dsh-meow-cachebilling) | 10 | ⚪ unknown | untranslated |
...
| [modlens](https://github.com/liustack/modlens) | 3856 | 🟢 ok | DeepSeek Harness 首个视觉插件，纯文本模型看图。 |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1149 | ⚪ unknown | 为纯文本模型看图设计的视觉工具箱与技能：多图理解、图片问答、UI 还原、GUI 自动化。 |
...
| [dsh-ui-appearance](https://github.com/TQSY114514/dsh-ui-appearance) | 12 | 🟢 ok | 外观自定义：主题色板、壁纸背景、透明度/模糊、毛玻璃效果，实时预览自动保存。 |
...
| [dsh-llm-codebuddy](https://github.com/Axiaohungry/dsh-llm-codebuddy) | 28 | 🟢 ok | 在deepseek harness中使用workbuddy api，因为公司只提供workbuddy积分 |
...
| [dsh-green-meter](https://github.com/dclichang2022/dsh-green-meter) | 101 | 🔴 broken (failed once, retried — install failed (exit 1):     at runPlugin (file:///home/runner/.npm/_npx/1e7f6d9597241db0/node_modules/@deepseek-ai/dsh/lib/plugin-9h8shc) | 能耗与碳排放计量：看每次对话/请求的能耗、缓存减碳量和电费。 |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 193 | ⚪ unknown | Token 记账：对账 New API 与 Sub2API 中转站账单。 |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 145 | 🟢 ok | Command Code 的 LLM provider（非官方）：实时模型目录、推理强度支持，Models 页有卡片。 |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 318 | 🟢 ok | 把 ChatGPT(Codex)、Claude、Grok(X Premium) 的订阅当 DSH 的模型 provider 用。 |
...
| [dsh-reasoning-effort](https://github.com/HanaAyane/dsh-reasoning-effort) | 126 | 🟢 ok | DSH适用的Codex风格的思考强度滑块，以及大肥鱼跑步滑块。Codex-style model and reasoning-effort slider for DeepSeek Harness |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 598 | ⚪ unknown | untranslated |
| [dsh-plugin-writing-guard](https://github.com/xmutfyh/dsh-plugin-writing-guard) | 32 | 🟢 ok | untranslated |
...
| [dsh-crew](https://github.com/ZSeven-W/dsh-crew) | 130 | 🟢 ok | untranslated |
| [dsh-media-skills](https://github.com/MJorgin/dsh-media-skills) | 19 | ⚪ unknown | untranslated |
| [picturereader](https://github.com/jing-hy/picturereader) | 36 | ⚪ unknown | untranslated |
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 49 | ⚪ unknown | untranslated |
...
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 305 | 🟢 ok | untranslated |
| [dsh-mmx-bridge](https://github.com/welsione/dsh-mmx-bridge) | 10 | ⚪ unknown | untranslated |
| [dsh-computer-use](https://github.com/988hj7tczd-oss/dsh-computer-use) | 23 | ⚪ unknown | untranslated |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1013 | ⚪ unknown | untranslated |
...
| [dsh-with-chatgpt](https://github.com/BeforeWave/dsh-with-chatgpt) | 41 | ⚪ unknown | untranslated |
...
| [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1061 | ⚪ unknown (watchlist 占位→plugins；dsh.client 声明完整) | 给纯文本 DSH 智能体装上眼睛：内置免 key 免费视觉链 + 11 个像素级视觉工具，一条命令安装，无需 Python。 |
| [dsh-antigravity](https://github.com/LiZhenNet/dsh-antigravity) | 19 | ⚪ unknown | untranslated |
...
| [opencode2dsh](https://github.com/FishBottle7/opencode2dsh) | 20 | ⚪ unknown | untranslated |
| [dsh-better-reasoning-effort](https://github.com/HaoyueQin/dsh-better-reasoning-effort) | 16 | ⚪ unknown | untranslated |
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 317 | ⚪ unknown | untranslated |
| [dsh-design-qa](https://github.com/sunxin-ai/dsh-design-qa) | 16 | 🟢 ok | untranslated |
| [dsh-llm-workbuddy](https://github.com/Axiaohungry/dsh-llm-workbuddy) | 28 | 🟢 ok | untranslated |
...
| [mirage-dsh](https://github.com/strukto-ai/mirage) | 3599 | 🟢 ok | 把 DSH 的 fs/shell 提供者换成 mirage 虚拟工作区：文件工具与 shell 命令作用于挂载的资源（RAM/磁盘/S3/Redis/Postgres/Slack/Gmail/Notion）而非宿主磁盘。 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6475 | ⚪ unknown | 带记忆、人格与自主性的个人 AI 智能体 |
| [exo](https://github.com/exoharness/exo) | 1306 | ⚪ unknown | 可递归自编辑自身的 agent+harness 架构 |
| [synergy](https://github.com/SII-Holos/synergy) | 548 | ⚪ unknown | 面向 Open Agentic Web 的通用智能体 |
| [ccteam](https://github.com/firstintent/ccteam) | 396 | ⚪ unknown | 把 Claude Code/Codex/Grok/Kimi 编成团队，Telegram/飞书指挥 |
...
| [distill](https://github.com/LoserFox/distill) | 24 | ⚪ unknown | 自动对话蒸馏：后台 subagent 反省 + 技能更新 |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1336 | 🟢 ok | AgentTeams 插件 |
...
| [dsh-work](https://github.com/vibeinging/dsh-desktop) | 636 | ⚪ unknown | 本地优先 DSH 桌面工作台（原 dsh-work 更名 dsh-desktop） |
...
| [dsh-harness-mcp-server](https://github.com/chushixixin/dsh-harness-mcp-server) | 11 | ⚪ unknown | dsh-harness-mcp-server — DSH 插件（编排） |
...
| [dsh-a2a](https://github.com/dpskh/dsh-a2a) | 8 | 🟢 ok | Agent 对 Agent 网格：让多个 DSH agent 之间直接互相通信协作。 |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3148 | ⚪ unknown | 通用技能调度器：自动挑选最合适的本地 Skill 并编排整个 Harness 工作流，不用手动指定用哪个技能。 |
...
| [sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | 112 | ⚪ unknown | 88 个可直接安装的 Agent 技能：覆盖研究与增长工作流，带 npm CLI 分发。 |
...
| [pptfast](https://github.com/liustack/pptfast) | 12 | ⚪ unknown | Stable, editable PPTX generation for AI agents — semantic IR in, native DrawingML out. DSH plugin + Claude Code plugin + CLI. | 给… |
...
| [dsh-awiki](https://github.com/AgentConnect/dsh-awiki) | 14 | 🟢 ok | AWiki identity and messaging plugin for DeepSeek Harness |
...
| [dsh_workflow](https://github.com/omdsh-dev/dsh_workflow) | 114 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
...
| [dsh-plugin-guard](https://github.com/lxzy-7/dsh-plugin-guard) | 40 | ⚪ unknown | untranslated |
| [dsh-file-upload](https://github.com/HongMing-Huang/dsh-file-upload) | 20 | 🟢 ok | untranslated |
...
| [dsh-agent-skills](https://github.com/minivv/dsh-agent-skills) | 12 | 🟢 ok | untranslated |
| [dsh-plugin-mcp-manager](https://github.com/HuanLinOTO/dsh-plugin-mcp-manager) | 4 | ⚪ unknown | untranslated |
| [dsh-quant](https://github.com/pengpengyi92/dsh-quant) | 29 | 🟢 ok | untranslated |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 76 | ⚪ unknown | untranslated |
...
| [dsh-ego-browser](https://github.com/Fisfzy/dsh-ego-browser) | 86 | ⚪ unknown | untranslated |
| [dsh-ux](https://github.com/ayuanwong/dsh-ux) | 14 | ⚪ unknown | untranslated |
| [dsh-agency-agents](https://github.com/MichengAI/dsh-agency-agents) | 35 | ⚪ unknown | untranslated |
| [dsh-skill-7d-code-reviewer](https://github.com/7dgroup-ai/dsh-skill-7d-code-reviewer) | 10 | ⚪ unknown | untranslated |
| [deep-read-summarize](https://github.com/PensiveFei/deep-read-summarize) | 26 | ⚪ unknown | untranslated |
| [holdem](https://github.com/shinjiyu/holdem) | 12 | ⚪ unknown | untranslated |
| [hedgehog](https://github.com/skyf0xx/hedgehog) | 35 | ⚪ unknown | untranslated |
| [dsh-router-standard](https://github.com/yjh051108/dsh-router-standard) | 363 | ⚪ unknown | untranslated |
...
| [dsh-raw-html](https://github.com/plolpl789/dsh-raw-html) | 51 | ⚪ unknown | untranslated |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 180 | ⚪ unknown | untranslated |
...
| [loopx](https://github.com/huangruiteng/loopx) | 5573 | ⚪ unknown | untranslated |
...
| [dsh-Visual-Workflow](https://github.com/GZX2211/dsh-Visual-Workflow) | 19 | ⚪ unknown | untranslated |
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 91 | ⚪ unknown | untranslated |
| [dsh-plugin-developer-skill](https://github.com/liangdabiao/dsh-plugin-developer-skill) | 16 | ⚪ unknown | untranslated |
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 136 | ⚪ unknown | untranslated |
| [dsh-trading](https://github.com/zhu1090093659/dsh-trading) | 75 | ⚪ unknown | untranslated |
...
| [deepseek-harness-lan](https://github.com/oitsukiii/deepseek-harness-lan) | 8 | ⚪ unknown | deepseek-harness-lan — DSH 插件（桥接） |
...
| [dsh-usage-stats](https://github.com/Ychris12138/dsh-usage-stats) | 139 | 🟢 ok | Token 用量热力图 + 分模型明细 + DeepSeek 账户余额，全部在一个 Web 面板里看。 |
...
| [dsh-easyssh](https://github.com/chenw2759-wq/dsh-easyssh) | 33 | ⚪ unknown | 用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。 |
| [dsh-plugin-deepseek-balance](https://github.com/fishxcode/dsh-plugin-deepseek-balance) | 2 | ⚪ unknown | Web 客户端实时显示 DeepSeek API 余额。 |
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 55 | 🟢 ok | 远程接入助手：/remote 命令 + 设置页直接打印 SSH 隧道/反向隧道命令，远程工作区一键连。 |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 56 | ⚪ unknown | 安卓伴侣应用：聊天、目标、审批与通知，手机随时遥控 DSH。 |
...
| [dsh-IDE](https://github.com/chenw2759-wq/dsh-IDE) | 33 | ⚪ unknown | 这是一个ssh前端程序，可以让UI体现类似lab的功能！用于远程ssh快速相应，同时可以直接在前端操作/查看远程服务器上的信息与代码。 |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 936 | 🟢 ok | untranslated |
...
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 202 | 🟢 ok | untranslated |
...
| [dsh-remote-web-gateway](https://github.com/summer1238/dsh-remote-web-gateway) | 168 | 🟢 ok | untranslated |
| [dsh-web-startup-auth](https://github.com/GDWhisper/dsh-web-startup-auth) | 24 | 🟢 ok | untranslated |
...
| [ds-harness-remote](https://github.com/liguobao/ds-harness-remote) | 159 | 🟢 ok | untranslated |
| [dsh-remote](https://github.com/SCSpotato/dsh-remote) | 25 | 🟢 ok | untranslated |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3157 | ⚪ unknown | 一键安装+切换 Claude Code/Codex/Kimi/Qwen 等 20+ 编码智能体 |
...
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 989 | ⚪ unknown | DSH 生态精选：插件、工具与基建 |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 253 | 🟢 ok | DSH 终端 UI（TUI） |
...
| [dsh-notification](https://github.com/omdsh-dev/dsh-notification) | 80 | 🟢 ok | DSH 桌面通知：任务回合结束弹系统通知，可按结果类型和关键词自定义哪些才提醒。 |
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 605 | ⚪ unknown | 2005 年中文站点风格侧栏广告插件（恶搞） |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 302 | 🔴 broken (dump-config exit=1 but plugin not found in composed tree) | 可扩展的 macOS DSH 工作台（原生 PTY） |
| [dsh-visualize](https://github.com/Nagi-ovo/dsh-visualize) | 254 | 🟢 ok | 对话内生成式 UI：把交互式 HTML 卡片画进会话 |
| [awesome-DSH-plugin](https://github.com/Alex-Yanggg/awesome-DSH-plugin) | 93 | ⚪ unknown | 精选 DSH 插件/扩展/工具列表 |
| [oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) | 55 | 🟢 ok | 面向 DSH 的插件生态（700+ 插件） |
| [dsh-gomoku](https://github.com/omdsh-dev/dsh-gomoku) | 17 | ⚪ unknown | 在 DSH 里与 AI 下五子棋 |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 311 | ⚪ unknown | 双语 DSH 插件生态完整列表 |
| [dsh-launcher](https://github.com/Ruler4396/dsh-launcher) | 194 | 🟢 ok | 基于 WebView2 的 DSH 启动器 |
| [dsh-minigames](https://github.com/lhh010/dsh-minigames) | 27 | ⚪ unknown | 右侧小游戏面板（18 款离线小游戏） |
...
| [dsh-notifier](https://github.com/THEWOLFWALKER/dsh-notifier) | 86 | 🟢 ok | untranslated |
...
| [dsh-meow-smooth](https://github.com/Phant0Meow/dsh-meow-smooth) | 36 | ⚪ unknown | untranslated |
| [harness-one](https://github.com/chumingjun/harness-one) | 17 | ⚪ unknown | untranslated |
| [dsh-dingtalk](https://github.com/DingTalk-Real-AI/dsh-dingtalk) | 14 | ⚪ unknown | untranslated |
| [dsh-harness-one](https://github.com/chumingjun/dsh-harness-one) | 17 | ⚪ unknown | untranslated |
| [dsh-wechat-article](https://github.com/aiworkskills/dsh-wechat-article) | 9 | ⚪ unknown | untranslated |

> 徽章含义：🟢 兼容 · 🔴 不兼容 · ⚪ 未实测 · ⚫ 弃坑。
> 共 1827 个条目，按分类分表、类内按 ⭐ 降序。收录 / 字段词典见 [docs/catalog-schema.md](docs/catalog-schema.md)。
<!-- CATALOG:END -->
