...
![Plugins](https://img.shields.io/badge/plugins-1875-facc15?style=flat-square)
...
![DSH Web UI 里的插件商店 Store 标签页](https://raw.githubusercontent.com/whyihaveyou/dsh-suite/c7cdc6d2dc41b80ee0f00f5af8c80fc025416ab0/site/assets/store-tab.png)
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 7258 | 🟢 ok | DSH Web UI 插件与皮肤合集：任务板、Git 面板等 |
| [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3470 | 🟢 ok | 侧边栏完整工作台：文件渲染/终端/Git/子代理 |
| [dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale) | 1983 | ⚪ unknown | DSH Web 鲸鱼娘皮肤系列（深海女仆工坊） |
| [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 872 | 🟢 ok | 给纯文本模型加视觉：图片问答、长截图 OCR、UI 还原 |
| [dsh_workflow](https://github.com/icetomoyo/dsh_workflow) | 119 | 🟢 ok | 把 Claude Code 的 UltraCode 模式带给 DSH，多 Agent 调度可治理 |
...
| [dsh-acp-for-bitfun](https://github.com/bobleer/dsh-acp-for-bitfun) | 9 | 🟢 ok | BitFun 与 DSH ACP 交互对接 |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [open-managed-agents](https://github.com/openma-ai/open-managed-agents) | 265 | ⚪ unknown | Claude Managed Agents API 的开源自托管平台（Cloudflare Workers） |
...
| [dsh-openbiliclaw](https://github.com/whiteguo233/dsh-openbiliclaw) | 58 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | OpenBiliClaw 内容推荐 Agent 接入 DSH |
...
| [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 355 | 🟢 ok | Mnemon 三层记忆体深度集成 |
...
| [dsh-tool-encoding](https://github.com/omdsh-dev/dsh-tool-encoding) | 5 | ⚪ unknown | base64/hex/url 编解码 + 哈希工具 |
...
| [dsh-openmaic](https://github.com/THU-MAIC/dsh-openmaic) | 60 | 🟢 ok | OpenMAIC：课堂/幻灯片/交互式组件 |
...
| [dsh-scholar](https://github.com/lzszq/dsh-scholar) | 43 | 🟢 ok | dsh-scholar（文献相关） |
...
| [ego-browser](https://github.com/Fisfzy/ego-browser) | 138 | 🟢 ok | 把 ego-lite 浏览器接入 DSH（给 Agent 用的 Chromium） |
...
| [modsearch](https://github.com/liustack/modsearch) | 449 | ⚪ unknown | DeepSeek Harness 的联网搜索插件。 |
| [dsh-browser](https://github.com/Lum1104/dsh-browser) | 618 | 🟢 ok | Chrome 侧边栏扩展，让 DSH 操控浏览器。 |
...
| [dsh-expression](https://github.com/yyh-001/dsh-expression) | 79 | 🟢 ok | 找得到、发得出 —— DSH 表情包插件：语义搜图，只发真实文件，走 companion QQ 通道 |
...
| [dsh-vsc-integration](https://github.com/HarcoChen/dsh-vsc-integration) | 11 | ⚪ unknown | dsh-vsc-integration — DSH 插件（工具） |
...
| [dsh-composer-history](https://github.com/PerryLink/dsh-composer-history) | 14 | 🟢 ok | dsh-composer-history — DSH 插件（工具） |
...
| [dsh-browser](https://github.com/ben7am1n/dsh-browser) | 6 | 🟢 ok | dsh-browser — DSH 插件（工具） |
...
| [dsh-turn-index](https://github.com/Simon314620/dsh-turn-index) | 3 | 🟢 ok | deepseek harness的侧边栏对话轮次索引插件 |
...
| [dsh-github](https://github.com/PerryLink/dsh-github) | 8 | 🟢 ok | dsh-github — DSH 插件（工具） |
...
| [dsh-port-guard](https://github.com/PangYiMing/dsh-port-guard) | 1 | 🟢 ok | dsh-port-guard — DSH 插件（工具） |
...
| [dsh-codex](https://github.com/Yan-Zero/dsh-codex) | 57 | 🟢 ok | dsh-codex — DSH 插件（工具） |
...
| [dsh-doctor](https://github.com/jorinyang/dsh-doctor) | 3 | 🟢 ok | dsh-doctor — DSH 插件（工具） |
...
| [dsh-auto](https://github.com/simon300000/dsh-auto) | 7 | ⚪ unknown | dsh-auto — DSH 插件（工具） |
| [dsh-annotate](https://github.com/BrambleXu/dsh-annotate) | 11 | ⚪ unknown | dsh-annotate — DSH 插件（工具） |
| [dsh-codex-connect](https://github.com/franksong2702/dsh-codex-connect) | 96 | 🟢 ok | 通过 ChatGPT OAuth 在 DeepSeek Harness 中使用 OpenAI Codex 模型。 |
| [DSH-Decktop](https://github.com/JustGenius-s/DSH-Decktop) | 22 | ⚪ unknown | DSH-Decktop — DSH 插件（工具） |
...
| [dsh-prompt-enhancer](https://github.com/Fishsb/dsh-prompt-enhancer) | 67 | 🟢 ok | DeepSeek Harness DSH 提示词增强插件：✨ 一键优化草稿 |
...
| [dsh-codex-subscription](https://github.com/WSL043/dsh-codex-subscription) | 52 | 🟢 ok | dsh-codex-subscription — DSH 插件（工具） |
...
| [Oh-My-DSH](https://github.com/NoWint/Oh-My-DSH) | 16 | 🟢 ok | DeepSeek Harness 插件精选集 · 300+ dsh-plugin 收录 · 22 大分类 |
...
| [dsh-plugin](https://github.com/acosmi/dsh-plugin) | 2 | 🟢 ok | 社区插件集合包。 |
...
| [dsh-input-history](https://github.com/omdsh-dev/dsh-input-history) | 3 | 🟢 ok | DSH Web 输入历史插件：Ctrl+Up / Ctrl+Down 像终端一样召回与切换已发送消息，零核心改动 |
...
| [MuseAI](https://github.com/yejiming/MuseAI) | 640 | ⚪ unknown | 创建你的 AI 角色，进入你的故事世界。和角色聊天、冒险、穿书，让每一次互动都留下羁绊（支持 DeepSeek Harness 插件，欢迎使用） |
...
| [dsh-plugins](https://github.com/wsxwj123/dsh-plugins) | 7 | ⚪ unknown | 插件集合（独立包，一个仓库管理）。 |
...
| [dsh-passwords](https://github.com/slywalker2006/dsh-passwords) | 47 | 🟢 ok | 让 DeepSeek Harness 变成服务器级多租户平台：远程访问 + 自动 HTTPS、子用户权限与配额、沙盒强制、加密认证与审计日志。 |
...
| [dsh-pub](https://github.com/dsh-pub/dsh-pub) | 4 | ⚪ unknown | dsh.pub 双语、源码背书的 DSH 插件注册表与安装器。 |
| [anysearch-dsh](https://github.com/anysearch-team/anysearch-dsh) | 407 | 🟢 ok | AnySearch 联网搜索接入：给 DSH 配上 AnySearch 的搜索 provider 和进阶搜索工具。 |
...
| [dsh-mindmap](https://github.com/chenw2759-wq/dsh-mindmap) | 5 | 🟢 ok | DSH 思维导图模式插件：课件(PPT/PDF/Word)+电子书 → 打印级复习思维导图 HTML（A3 横向、每主干一页、大括号式横向、宋体、右栏笔记区、封面总览 + 交互式测试题） |
...
| [dsh-pet](https://github.com/PC2005-cloud/dsh-pet) | 583 | 🟢 ok | DeepSeek Harness 桌面宠物插件 + 完整素材生成链：AI 提示词 → 绿幕视频 → 透明动画 → 可安装插件，从零到宠物全流程可复现 |
...
| [dsh-agy](https://github.com/chaos-03x/dsh-agy) | 35 | 🟢 ok | Google Antigravity (agy) 接入：OAuth 授权 + 多账号池 + 429 自动轮换 + 设备指纹。 |
...
| [dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) | 3816 | ⚪ unknown | 两段式 Agent 预设：先用精简配置快速启动，再切换到完整 Standard 工具集，兼顾启动速度与全功能。 |
...
| [dsh-museai-tavern](https://github.com/yejiming/dsh-museai-tavern) | 19 | ⚪ unknown | MuseAI的DeepSeek Harness插件，可以将你的MuseAI角色放进DSH使用啦！ |
| [citeguard](https://github.com/Chhlafiu4312/citeguard) | 3 | ⚪ unknown | 引用提取与证据核验：帮 agent 的回答带可验证出处。 |
| [dsh-commandcode-go-provider](https://github.com/jiesou/dsh-commandcode-go-provider) | 9 | ⚪ unknown | Command Code Go API provider for dsh. Command Code 订阅 + DeekSeek Harness 兼容层 |
...
| [dsh-satori](https://github.com/Ri0n72Y/dsh-satori) | 1 | 🟢 ok | 连接 DSH 与 Satori 服务器，获得 IM 能力。 |
...
| [plugin-deus (神模扳机)](https://github.com/whyihaveyou/dsh-suite/tree/main/packages/plugin-deus) | 1 | 🟢 ok | 神模扳机：一键触发实测验证过的 Minimal 行为，起手指纹自动识别回复模式，本地触发率统计（Wilson CI）。提示词实验台，不承诺任何隐藏能力。 |
| [dsh-tavern](https://github.com/Player-MINEPIG/dsh-tavern) | 12 | 🟢 ok | 让 DSH 兼容 SillyTavern 的卡牌/世界书等产物并支持运行时加载。 |
...
| [deepseek-harness-for-vscode](https://github.com/skymecode/deepseek-harness-for-vscode) | 147 | ⚪ unknown | deepseek-harness 的 VS Code 社区扩展。 |
...
| [dsh-auto-mode](https://github.com/NanmiCoder/dsh-auto-mode) | 151 | 🟢 ok | 安全的自动授权：在「每次都要点批准」和「无脑全放开」之间加一档，按规则自动放行常规操作。 |
...
| [dsh-hanako](https://github.com/Nyasers/dsh-hanako) | 47 | ⚪ unknown | 把 DSH 接进 Hana：作为进程外 subagent 使用，任务走 dsh web host 执行。 |
...
| [oh-my-dsh](https://github.com/LiuMengxuan04/oh-my-dsh) | 13 | 🟢 ok | Oh My DSH (DSH Autopilot): durable, bounded autonomous development for DeepSeek Harness |
| [LaoA-dshGF](https://github.com/zhulin025/LaoA-dshGF) | 2 | ⚪ unknown | DeepSeek Harness 赛博女友插件 |
| [dsh-free-search](https://github.com/DDDMUC/dsh-free-search) | 159 | 🟢 ok | Free web search provider for DeepSeek Harness - DuckDuckGo backend, no API key needed |
...
| [dsh-save-money](https://github.com/zhu168/dsh-save-money) | 37 | 🟢 ok | untranslated |
| [oh-my-dsh](https://github.com/amplifthq/oh-my-dsh) | 15 | 🟢 ok | untranslated |
...
| [dsh-win32](https://github.com/sjh9714/dsh-win32) | 36 | 🟢 ok | untranslated |
| [dsh-plugin-store](https://github.com/0xKcyzz/dsh-plugin-store) | 6 | 🟢 ok | untranslated |
| [dsh-backup](https://github.com/xiaoyuyu6420/dsh-backup) | 18 | 🟢 ok | untranslated |
...
| [dsh-permgate](https://github.com/MrWeiCodes/dsh-permgate) | 4 | ⚪ unknown | untranslated |
| [anime-find](https://github.com/cocofhu/anime-find) | 166 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
| [DSH-Think-zh](https://github.com/Len7183/DSH-Think-zh) | 19 | ⚪ unknown | untranslated |
| [dsh-anchored-standard](https://github.com/Jungod1121/dsh-anchored-standard) | 27 | ⚪ unknown | untranslated |
| [dsh-pentest](https://github.com/howmp/dsh-pentest) | 413 | 🟢 ok | untranslated |
...
| [helm-d](https://github.com/ADWMC/helm-d) | 35 | ⚪ unknown | untranslated |
| [dsh-mcp-manager](https://github.com/Js2Hou/dsh-mcp-manager) | 19 | 🔴 broken (failed once, retried — install failed (exit 1):     at runPlugin (file:///home/runner/.npm/_npx/1e7f6d9597241db0/node_modules/@deepseek-ai/dsh/lib/plugin-9h8shc) | untranslated |
...
| [dsh-tool-autoexpand](https://github.com/better-er/dsh-tool-autoexpand) | 10 | 🟢 ok | untranslated |
| [dsh-conversation-outline](https://github.com/lzbaclz/dsh-conversation-outline) | 8 | 🟢 ok | untranslated |
| [deepseek-aix](https://github.com/PHoenixs57/deepseek-aix) | 6 | ⚪ unknown | untranslated |
| [dsh-filescope](https://github.com/KunIsMe/dsh-filescope) | 5 | 🟢 ok | untranslated |
...
| [dsh-trading](https://github.com/maddogfinance/dsh-trading) | 34 | ⚪ unknown | untranslated |
...
| [dsh-ai4scholar](https://github.com/literaf/dsh-ai4scholar) | 21 | 🟢 ok | untranslated |
...
| [dsh-meme](https://github.com/yyh-001/dsh-meme) | 79 | 🟢 ok | untranslated |
| [oss-prompt-optimizer](https://github.com/seven282/oss-prompt-optimizer) | 14 | 🟢 ok | untranslated |
...
| [dsh-univer-office](https://github.com/dream-num/dsh-univer-office) | 313 | 🟢 ok | untranslated |
...
| [dsh-taskboard](https://github.com/cloader/dsh-taskboard) | 37 | 🟢 ok | untranslated |
...
| [dsh-redteam-model](https://github.com/SeaOf0/dsh-redteam-model) | 361 | 🟢 ok | untranslated |
...
| [deepseek-harness-quota-monitor](https://github.com/marisa-4219/deepseek-harness-quota-monitor) | 8 | 🟢 ok | untranslated |
| [dsh-ears](https://github.com/WizisCool/dsh-ears) | 18 | 🟢 ok | untranslated |
| [dsh-oil-creator](https://github.com/oil-oil/dsh-oil-creator) | 181 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
...
| [garmin-connect-plugin-for-dsh](https://github.com/Likenttt/garmin-connect-plugin-for-dsh) | 15 | ⚪ unknown | untranslated |
| [wallpaper-plugin](https://github.com/Ayase34/wallpaper-plugin) | 10 | ⚪ unknown | untranslated |
| [dsh-tether](https://github.com/zexadev/dsh-tether) | 43 | ⚪ unknown | untranslated |
| [dsh-personal-center](https://github.com/PolinniZhong/dsh-personal-center) | 90 | 🟢 ok | untranslated |
| [dsh-server-login](https://github.com/pointer-a/dsh-server-login) | 21 | ⚪ unknown | untranslated |
...
| [dsh-ros2](https://github.com/StvLi/dsh-ros2) | 20 | 🟢 ok | untranslated |
...
| [Invoice-Downloader](https://github.com/EthanYoQ/Invoice-Downloader) | 405 | ⚪ unknown | untranslated |
...
| [dsh-obsidian](https://github.com/mingzeng21/dsh-obsidian) | 13 | 🟢 ok | untranslated |
| [dsh-ssh-ops](https://github.com/caoyiwei850/dsh-ssh-ops) | 18 | 🟢 ok | untranslated |
...
| [dsh-preset-plus](https://github.com/Rain-kl/dsh-preset-plus) | 97 | 🟢 ok | untranslated |
| [dsh-console](https://github.com/cofy-x/dsh-console) | 22 | 🟢 ok | untranslated |
| [dsh-prompt-optimizer](https://github.com/Y1X1n/dsh-prompt-optimizer) | 12 | 🟢 ok | untranslated |
...
| [dsh-infinite-gen-2](https://github.com/Minglink/dsh-infinite-gen-2) | 1205 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
...
| [dsh-research-report](https://github.com/PerryLink/dsh-research-report) | 81 | 🟢 ok | untranslated |
...
| [dsh-infinite-gen-3](https://github.com/Minglink/dsh-infinite-gen-3) | 1205 | 🟢 ok | untranslated |
| [dsh-diagram](https://github.com/hanzhangzzz/dsh-diagram) | 12 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
| [@xxxyz/dsh-mcp-manager](https://github.com/xxxyz/DeepSeekHarness-MCP-Manager) | 13 | 🟢 ok | DSH 双管理器——MCP 服务管理（设置页新增/编辑/启停/重启/删除、JSON 导入导出、4 个 mcp_manager_* 模型工具、带闸门的本地 HTTP API）+ Skills 技能管理（启停面板、持久化、HMR 即时生效）。 |
| [dsh-data-quality](https://github.com/PerryLink/dsh-data-quality) | 20 | 🟢 ok | untranslated |
| [unity-plugin](https://github.com/opdsh/unity-plugin) | 52 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
| [dsh-plugin-shop](https://github.com/LivXue/dsh-plugin-shop) | 450 | 🟢 ok | untranslated |
| [dsh-tinyfish-search](https://github.com/maxwell-feng/dsh-tinyfish-search) | 18 | 🟢 ok | untranslated |
...
| [dsh-approval-gate](https://github.com/moon09300731/dsh-approval-gate) | 52 | 🟢 ok | untranslated |
| [dsh-knowledge](https://github.com/lemoncat7/dsh-knowledge) | 11 | 🟢 ok | untranslated |
| [prts-terrarchive](https://github.com/HTian-qwq/prts-terrarchive) | 21 | ⚪ unknown | untranslated |
| [dsh-superpower](https://github.com/Wenaixi/dsh-superpower) | 13 | 🟢 ok | untranslated |
| [dsh-council](https://github.com/a1exsun/dsh-council) | 21 | ⚪ unknown | untranslated |
| [dsh-prompt-library](https://github.com/master1Sun/dsh-prompt-library) | 10 | ⚪ unknown | untranslated |
| [dsh-mcp-connector](https://github.com/duhu2000/dsh-mcp-connector) | 20 | 🟢 ok | DeepSeek Harness 通用 MCP 连接器与连接器市场：支持 OAuth 2.0 PKCE、API Key、stdio/HTTP、mcpServers JSON 导入、工具与 Prompt。 |
| [dsh-image-gen-goodandready](https://github.com/GooDAnDReaDY/dsh-image-gen) | 4 | 🟢 ok | generate_image 图像生成工具：走 FAL 队列 / 任意 OpenAI 兼容图像 API / ChatGPT·Grok 订阅，结果内联显示在会话里。 |
| [dsh-vision-bridge-goodandready](https://github.com/GooDAnDReaDY/dsh-vision-bridge) | 1 | 🟢 ok | 视觉桥：把图片路由给你选的视觉模型，纯文本模型遇到带图回合也不会失败。 |
| [dsh-grok-xsearch](https://github.com/GooDAnDReaDY/dsh-grok-xsearch) | 0 | 🟢 ok | X/Twitter 搜索工具（x_search），用独立的 SuperGrok OAuth 账号鉴权。 |
| [dsh-fylar-office-editor](https://github.com/FylarOpen/dsh-fylar-office-editor) | 13 | ⚪ unknown | untranslated |
| [dsh-defend](https://github.com/PerryLink/dsh-defend) | 11 | 🟢 ok | untranslated |
...
| [superpowers-dsh](https://github.com/LayneChai/superpowers-dsh) | 89 | 🟢 ok | Superpowers 技能包移植版：TDD、调试、规划、协作等经典工作流技能，装进 DSH 直接用。 |
| [dsh-skill-viewer](https://github.com/Fishquito7/dsh-skill-viewer) | 118 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 技能管理面板：在设置页直接启用/停用、删除、添加 Skills，不用改配置文件。 |
...
| [dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill) | 126 | 🟢 ok | 逆向技能全家桶（85 个 SKILL.md）：逆向工程、授权渗透和安全研究的工作流，打包成插件。 |
...
| [dsh-skills-manager](https://github.com/MichengAI/dsh-skills-manager) | 42 | 🟢 ok | untranslated |
...
| [cleverer-dsh](https://github.com/Classicoke/cleverer-dsh) | 14 | ⚪ unknown | untranslated |
...
| [dsh-skill-mcp-panel](https://github.com/Fishquito7/dsh-skill-mcp-panel) | 118 | 🟢 ok | untranslated |
...
| [oh-story-dsh](https://github.com/worldwonderer/oh-story-dsh) | 331 | ⚪ unknown | untranslated |
...
| [dsh-mattpocock-skills-deck](https://github.com/FeatherHunter/dsh-mattpocock-skills-deck) | 57 | 🟢 ok | untranslated |
| [oh-story-dsh](https://github.com/zenstory-ai/oh-story-dsh) | 331 | ⚪ unknown | untranslated |
| [dsh-industry-research](https://github.com/PerryLink/dsh-industry-research) | 84 | 🟢 ok | untranslated |
...
| [dsh-annotation](https://github.com/omdsh-dev/dsh-annotation) | 113 | 🟢 ok | 选中批注：选文字→批注→随消息发送 |
...
| [tonghuashun-webui](https://github.com/renat3u/tonghuashun-webui) | 20 | ⚪ unknown | 仿同花顺的webui插件 |
...
| [dsh-drag-and-drop](https://github.com/bill9109/dsh-drag-and-drop) | 24 | 🟢 ok | 跨平台文件拖拽与原始路径插入 |
| [dsh-qq2006](https://github.com/LaplaceYoung/dsh-qq2006) | 27 | ⚪ unknown | QQ2006 皮肤插件 |
| [dsh-session-notification](https://github.com/dingyi222666/dsh-session-notification) | 19 | ⚪ unknown | 会话完成等四状态通知 |
...
| [whale-girl](https://github.com/vlln/whale-girl) | 321 | 🟢 ok | QQ 宠物形态的桌面宠物插件 |
| [dsh-status-rotator](https://github.com/01Virex/dsh-status-rotator) | 78 | 🟢 ok | 替换 DSH 状态显示的 web 插件。 |
...
| [dsh-portable-tavern](https://github.com/XCNXNXNX/dsh-portable-tavern) | 21 | 🟢 ok | DeepSeek Harness 的「便携酒馆」插件：RPG 式 SillyTavern V2/V3 角色卡生成器 + 酒馆角色扮演聊天。支持世界书、角色卡 JSON/PNG 导入导出、面板主题与本地音乐。独立插件，仅依赖官方 @deepseek-ai SD… |
...
| [dsh-auto-continue](https://github.com/HsiangNianian/dsh-auto-continue) | 83 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | DSH Web UI plugin: automatically sends "继续" (continue) when a request is interrupted by network errors or other non-human causes |
...
| [dsh-theme-taffy](https://github.com/Misaki14987/dsh-theme-taffy) | 5 | ⚪ unknown | 我不是雏草姬 |
...
| [dsh-undo-plugin](https://github.com/lire1131/dsh-undo-plugin) | 151 | 🟢 ok | 配置后悔药：插件/皮肤/设置改动自动快照，可撤销、可回滚，带快照管理面板和快捷键。 |
| [plugin-manager](https://github.com/whyihaveyou/dsh-suite) | 7 | 🟢 ok | DSH Web UI 内置插件商店：浏览 dsh-suite 目录、搜索/筛选/排序、兼容徽章、一键安装——设置页插件区的 Store 标签页。 |
...
| [touhou-hakurei](https://github.com/xiake595/touhou-hakurei) | 19 | ⚪ unknown | 灵梦（Reimu）·博丽神社（东方Project）美化版皮肤：神社昼夜实景背景、灵梦立绘、画框侧边栏与输入框、纸白透明界面 — DeepSeek Harness Web GUI skin |
...
| [dsh-theme-pack](https://github.com/math-lrz/dsh-theme-pack) | 2 | 🟢 ok | 16 套第三方主题皮肤：Catppuccin/Gruvbox/Everforest 等。 |
...
| [dsh-width-tiers](https://github.com/aaronlei/dsh-width-tiers) | 3 | 🟢 ok | 聊天内容宽度分级：不同场景不同版心宽度。 |
...
| [dsh-client-ui-skin-claude](https://github.com/PAKIKNOWLEDGE/dsh-client-ui-skin-claude) | 10 | ⚪ unknown | Claude 风格皮肤：暖黑画布 + Anthropic 配色。 |
...
| [dsh-any-background](https://github.com/Tkingxiao/dsh-any-background) | 23 | 🟢 ok | 一个自定义主题插件，包括背景图（大小和位置），主界面和设置界面（透明度，色轮全色主题色）插件 |
...
| [dsh-liang-skin](https://github.com/kingOfSoySauce/dsh-liang-skin) | 179 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 滑动变祖器皮肤：滑块控制『梁圣等级』（自适应推理强度），梗图风 DSH 皮肤 |
| [dsh-skin-switcher](https://github.com/zhtx2024/dsh-skin-switcher) | 4 | 🟢 ok | DeepSeek Harness Web GUI 皮肤切换插件：设置界面一键切换已安装皮肤 |
| [dsh-font](https://github.com/tianyhjg-lab/dsh-font) | 13 | ⚪ unknown | Font switcher for DeepSeek Harness Web GUI: 99 UI fonts + 31 code fonts with CJK-Latin pairing, instant apply, localStorage persi… |
| [dsh-maid-whale-webUI](https://github.com/yunxiiQwQ/dsh-maid-whale-webUI) | 28 | ⚪ unknown | DeepSeek Harness Web UI 鲸鱼女仆主题插件 |
...
| [dsh-plugin-terminal](https://github.com/mervyn-teo/dsh-plugin-terminal) | 3 | 🟢 ok | DeepSeek Harness Web plugin: a real PTY terminal in a VS Code-style collapsible footer panel |
...
| [deepseek-harness-genui](https://github.com/pengyue-polaron/deepseek-harness-genui) | 108 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
| [dsh-smooth-stream](https://github.com/Laplace-bit/dsh-smooth-stream) | 70 | 🟢 ok | 为 DeepSeek Harness Web UI 提供流畅流式渲染和丝滑滚动。 |
| [voyager](https://github.com/Nagi-ovo/voyager) | 20015 | ⚪ unknown | untranslated |
| [dsh-im](https://github.com/xmanrui/dsh-im) | 1247 | 🟢 ok | untranslated |
...
| [dsh-client-ui-custom](https://github.com/yoli-mi/dsh-client-ui-custom) | 30 | ⚪ unknown | untranslated |
...
| [dsh-endfield-ui](https://github.com/rison114514/dsh-endfield-ui) | 59 | ⚪ unknown | untranslated |
| [dsh-remote](https://github.com/Hyna-hla/dsh-remote) | 13 | 🟢 ok | untranslated |
| [dsh-web-tools](https://github.com/A3Boy/dsh-web-tools) | 26 | ⚪ unknown | untranslated |
...
| [DeepSeek-Balance-Whale-Widget](https://github.com/MeteorNOX/DeepSeek-Balance-Whale-Widget) | 1997 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
| [dsh-opencode-palette](https://github.com/FeatherHunter/dsh-opencode-palette) | 23 | 🟢 ok | untranslated |
| [dsh-whale-meter](https://github.com/Shiye-10Pages/dsh-whale-meter) | 11 | 🟢 ok | untranslated |
| [dsh-kimino-theme](https://github.com/niiang/dsh-kimino-theme) | 31 | 🟢 ok | untranslated |
| [dsh-beauty-skins](https://github.com/XieRW/dsh-beauty-skins) | 101 | ⚪ unknown | untranslated |
| [open-sea-skin](https://github.com/d-dev0101/open-sea-skin) | 342 | 🟢 ok | untranslated |
...
| [dsh-vscode](https://github.com/Fengze233/dsh-vscode) | 32 | ⚪ unknown | untranslated |
| [dsh-prompt-optimize](https://github.com/1847123733/dsh-prompt-optimize) | 6 | 🟢 ok | untranslated |
| [dsh-undo-savepoint](https://github.com/lire1131/dsh-undo-savepoint) | 151 | 🟢 ok | untranslated |
| [dsh-code-review](https://github.com/CooStack/dsh-code-review) | 7 | 🟢 ok | untranslated |
| [dsh-knowledge](https://github.com/Soren-ABT/dsh-knowledge) | 29 | 🟢 ok | untranslated |
| [dsh-aemeath](https://github.com/hachimi-ai/dsh-aemeath) | 5 | ⚪ unknown | untranslated |
| [dsh-tavily](https://github.com/moguiyu/dsh-tavily) | 9 | 🟢 ok | untranslated |
| [dsh-codex-ui](https://github.com/MichengAI/dsh-codex-ui) | 64 | 🟢 ok | untranslated |
| [dsh-theme-endfield](https://github.com/ymh0000123/dsh-theme-endfield) | 76 | 🟢 ok | untranslated |
...
| [DSH-Mobile](https://github.com/SimonMedy/DSH-Mobile) | 15 | 🟢 ok | untranslated |
| [dsh-coding-subscription-oauth](https://github.com/lninghaha/dsh-coding-subscription-oauth) | 20 | 🔴 broken (cordis 4.0.2 not in peer "4.0.1") | untranslated |
...
| [dsh-agy-link](https://github.com/amlyczz/dsh-agy-link) | 52 | 🟢 ok | untranslated |
| [dsh-bloom-theme](https://github.com/webkubor/dsh-bloom-theme) | 26 | ⚪ unknown | untranslated |
...
| [dsh-history-tree](https://github.com/z953218350/dsh-history-tree) | 18 | 🟢 ok | untranslated |
...
| [dsh-raw-html-v2](https://github.com/plolpl789/dsh-raw-html-v2) | 35 | ⚪ unknown | untranslated |
| [dsh-voice-goodandready](https://github.com/GooDAnDReaDY/dsh-voice) | 3 | 🟢 ok | Web UI 语音输入：按停顿分段的流式听写 + 语音消息，每条可配独立的多服务商回退链。 |
...
| [dsh-russian-lang](https://github.com/GooDAnDReaDY/dsh-russian-lang) | 8 | 🟢 ok | Settings → General → Language 增加俄语选项：核心 + 30+ 插件 locale 命名空间运行时翻译（722+3989 键人工审校）。 |
| [dsh-infinite-gen-4](https://github.com/Minglink/dsh-infinite-gen-4) | 1205 | ⚪ unknown | untranslated |
...
| [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 294 | 🟢 ok | 跨会话长期记忆 + 后台自我进化（纯插件） |
...
| [plugin-session-export](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | 把 append-only 会话日志导出成人读的 Markdown / HTML，按来源分组渲染（系统提示 / 思维链 / 工具调用 / 子agent）。 |
| [dsh-chat-import](https://github.com/Nwflower/dsh-chat-import) | 145 | 🟢 ok | 从 Claude Code/Codex/Reasonix 导入历史消息到 DSH。 |
...
| [dsh-goal-mode-enhance](https://github.com/KarlOfLaw/dsh-goal-mode-enhance) | 4 | ⚪ unknown | 为 DeepSeek Harness 提供可视化 goal 模式：Goal 栏 / 头部入口 / 设置页（历史+多会话总览）/ goal_overview 模型工具 |
...
| [dsh-claude-move](https://github.com/PerryLink/dsh-claude-move) | 19 | 🟢 ok | dsh-claude-move — DSH 插件（会话） |
...
| [dsh-session-timeline](https://github.com/XiLuovo/dsh-session-timeline) | 5 | 🟢 ok | DeepSeek Harness 会话时间轴插件：横短横线波浪、当前消息定位、点击跳转、圆角预览 tooltip、可收起/展开 |
...
| [billion-context-dsh](https://github.com/Tyan66666/billion-context-dsh) | 78 | 🟢 ok | billion-context-dsh — DSH 插件（会话） |
...
| [dsh-memento](https://github.com/PerryLink/dsh-memento) | 81 | 🟢 ok | dsh-memento — DSH 插件（会话） |
...
| [dsh-mneme](https://github.com/modusensus/dsh-mneme) | 92 | 🟢 ok | Mneme——把记忆主权还给人的记忆插件：SQLite + 可人工编辑的 Markdown 双写，autoDream 在梦境中巩固记忆，106 个测试护航。 |
| [dsh-cost-meter](https://github.com/Han-1413141/dsh-cost-meter) | 269 | 🟢 ok | DeepSeek Harness 会话费用统计插件:本会话费用、当日费用、历史记录与官方价格同步 |
...
| [dsh-auto-review](https://github.com/PerryLink/dsh-auto-review) | 152 | 🟢 ok | dsh-auto-review — DSH 插件（会话） |
...
| [dsh-tdai-memory](https://github.com/Scorp1o117/dsh-tdai-memory) | 8 | 🟢 ok | dsh-tdai-memory — DSH 插件（会话） |
...
| [dsh-auto-memory](https://github.com/Aik358/dsh-auto-memory) | 58 | 🟢 ok | DSH 自动记忆插件:三层记忆(用户级/项目笔记/每日日志)自动注入与检索、每日反思、可视化面板与设置页,支持继承其他 AI 工具的历史记忆。 |
...
| [dsh-session-deeplink](https://github.com/R3alloc/dsh-session-deeplink) | 6 | 🟢 ok | 会话深链分享：生成可分享的链接直达某个 DSH 会话。 |
...
| [dsh-memory](https://github.com/FuRongJun-1999/dsh-memory) | 152 | 🟢 ok | 多 agent 时空记忆图谱：跨会话持久记忆。 |
| [dsh-noema](https://github.com/ZSeven-W/dsh-noema) | 129 | 🟢 ok | Noema 长期记忆：持久、可检查的 agent 记忆，带召回工具和设置页。 |
| [dsh-memoir](https://github.com/Qinling-Melon-Farmers/dsh-memoir) | 25 | 🟢 ok | DSH 项目持久化记忆插件（TypeScript）：会话归纳 + 经验教训沉淀，写入 PROJECT_MEMORY.md 与全局索引；每轮工作结束自动提醒蒸馏、自动注入未来 AGENTS；附 Web GUI 记忆面板（项目/全局 tab、检索、手动记录/删除… |
...
| [dsh-browser](https://github.com/wqty123/dsh-browser) | 53 | 🟢 ok | 共享真实浏览器插件：多个 agent 共用一个浏览器。 |
...
| [dsh-files](https://github.com/taxueseek/dsh-files) | 35 | ⚪ unknown | 双面插件：会话隔离的文件上传（彩色卡片）+ 文档读取工具（text/PDF/DOCX/XLSX）。 |
...
| [dsh-voice](https://github.com/3274375092/dsh-voice) | 8 | 🟢 ok | DeepSeek Harness 的语音输入插件:网页里点 🎤(或按Ctrl+空格)说话,识别文本作为普通消息提交进会话。纯输入,与 agent preset/人设完全解耦,任何模式下都只是"另一种输入法"。 |
...
| [dsh-all-warmup](https://github.com/brunhildzhou/dsh-all-warmup) | 5 | 🟢 ok | untranslated |
...
| [dsh-board](https://github.com/dfkai/dsh-board) | 8 | 🟢 ok | untranslated |
| [dsh-web-remote](https://github.com/godchen520/dsh-web-remote) | 10 | 🟢 ok | untranslated |
...
| [dsh-change-review](https://github.com/cirelir/dsh-change-review) | 13 | ⚪ unknown | untranslated |
...
| [MemOS](https://github.com/MemTensor/MemOS) | 11253 | ⚪ unknown | untranslated |
...
| [dsh-tavern](https://github.com/chen731215-dev/dsh-tavern) | 39 | 🟢 ok | untranslated |
...
| [dsh-config-manager](https://github.com/xiajiajun516/dsh-config-manager) | 100 | 🟢 ok | untranslated |
| [dsh-archive-manager](https://github.com/MichengAI/dsh-archive-manager) | 49 | 🟢 ok | untranslated |
| [dsh-rewind](https://github.com/SiriLee/dsh-rewind) | 48 | 🟢 ok | untranslated |
...
| [dsh-talk-map](https://github.com/Tasihi89/dsh-talk-map) | 83 | 🟢 ok | untranslated |
| [dsh-flowglass](https://github.com/Iwctwbh/dsh-flowglass) | 19 | 🟢 ok | untranslated |
...
| [dsh-adult-tension](https://github.com/daha1216/dsh-adult-tension) | 25 | ⚪ unknown | untranslated |
...
| [StrataGate-AgentMemory](https://github.com/diqierjia/StrataGate-AgentMemory) | 72 | 🔴 broken (failed once, retried — install blocked by pnpm build-script policy (allowBuilds) — plugin likely OK, CI policy blocks git prepare scripts) | untranslated |
...
| [dsh-archive-manager](https://github.com/z953218350/dsh-archive-manager) | 13 | 🟢 ok | untranslated |
...
| [dsh-model-context-catalog](https://github.com/HOWILLMAKEIT/dsh-model-context-catalog) | 31 | 🟢 ok | untranslated |
...
| [dsh-kb-rag](https://github.com/Breeze136/dsh-kb-rag) | 12 | 🟢 ok | untranslated |
...
| [clutch-dsh](https://github.com/Cerbur/clutch-dsh) | 13 | ⚪ unknown | untranslated |
| [dsh-memgas](https://github.com/quqxui/dsh-memgas) | 16 | ⚪ unknown | untranslated |
...
| [dsh-vision](https://github.com/william-jin-cmu/dsh-vision) | 33 | 🟢 ok | view_image 工具桥接任意 OpenAI 兼容 VLM |
| [modlens](https://github.com/liustack/modlens) | 3933 | 🟢 ok | DeepSeek Harness 首个视觉插件，纯文本模型看图。 |
| [agent-vision-toolkit](https://github.com/Anionex/agent-vision-toolkit) | 1192 | ⚪ unknown | 为纯文本模型看图设计的视觉工具箱与技能：多图理解、图片问答、UI 还原、GUI 自动化。 |
| [dsh-tool-turbo](https://github.com/Electricitysheep/dsh-tool-turbo) | 7 | ⚪ unknown | 每轮 reasoning_effort 优化器。 |
| [dsh-plugin-cost-tracker](https://github.com/YYTbit/dsh-plugin-cost-tracker) | 3 | 🟢 ok | DeepSeek Harness token 成本追踪器。 |
...
| [dsh-llm-codebuddy](https://github.com/Axiaohungry/dsh-llm-codebuddy) | 30 | 🟢 ok | 在deepseek harness中使用workbuddy api，因为公司只提供workbuddy积分 |
...
| [dsh-skin](https://github.com/Yugitan/dsh-skin) | 1 | 🟢 ok | 可定制换肤：渐变预设、图片背景等。 |
...
| [ds-image-skin](https://github.com/ahren112/ds-image-skin) | 1 | ⚪ unknown | 图片换肤：上传任意图片自动提取主色、生成整套明/暗主题并设为壁纸。 |
...
| [TokenLedger](https://github.com/zh667/TokenLedger) | 198 | ⚪ unknown | Token 记账：对账 New API 与 Sub2API 中转站账单。 |
...
| [dsh-commandcode-provider](https://github.com/Mars-Sea/dsh-commandcode-provider) | 174 | 🟢 ok | Command Code 的 LLM provider（非官方）：实时模型目录、推理强度支持，Models 页有卡片。 |
| [dsh-plugin-subscriptions](https://github.com/V1ki/dsh-plugin-subscriptions) | 332 | 🟢 ok | 把 ChatGPT(Codex)、Claude、Grok(X Premium) 的订阅当 DSH 的模型 provider 用。 |
...
| [dsh-token-usage](https://github.com/LeemanCheung/dsh-token-usage) | 14 | 🟢 ok | Token 可观测性：持久统计模型用量，手动选择已接入模型生成用量与会话轨迹分析。 |
...
| [dsh-math-team](https://github.com/OrinVoss/dsh-math-team) | 8 | ⚪ unknown | 数学建模小队预设包：建模编码/论文写作 2 个角色预设。 |
...
| [dsh-reasoning-effort](https://github.com/HanaAyane/dsh-reasoning-effort) | 133 | 🟢 ok | DSH适用的Codex风格的思考强度滑块，以及大肥鱼跑步滑块。Codex-style model and reasoning-effort slider for DeepSeek Harness |
...
| [deepseek-harness-studio](https://github.com/fufankeji/deepseek-harness-studio) | 623 | ⚪ unknown | untranslated |
| [dsh-plugin-writing-guard](https://github.com/xmutfyh/dsh-plugin-writing-guard) | 34 | 🟢 ok | untranslated |
...
| [dsh-client-ui-skins](https://github.com/caoyiwei850/dsh-client-ui-skins) | 11 | 🟢 ok | untranslated |
...
| [dsh-wechat](https://github.com/pan17/dsh-wechat) | 9 | 🟢 ok | untranslated |
| [dsh-deepseek-vision](https://github.com/siegfly/dsh-deepseek-vision) | 8 | 🟢 ok | untranslated |
...
| [dsh-crew](https://github.com/ZSeven-W/dsh-crew) | 137 | 🟢 ok | untranslated |
...
| [dsh-imagegen](https://github.com/dickpy/dsh-imagegen) | 64 | 🟢 ok | untranslated |
...
| [dsh-directorx](https://github.com/LaplaceYoung/dsh-directorx) | 28 | ⚪ unknown | untranslated |
| [dsh-studio](https://github.com/jiuge2467/dsh-studio) | 12 | ⚪ unknown | untranslated |
| [opencues](https://github.com/opencues/opencues) | 46 | ⚪ unknown | untranslated |
| [dsh-live2d-mygo](https://github.com/U1s1-king/dsh-live2d-mygo) | 9 | ⚪ unknown | untranslated |
| [dsh-image-gen](https://github.com/shanliuling/dsh-image-gen) | 387 | 🟢 ok | untranslated |
| [dsh-mmx-bridge](https://github.com/welsione/dsh-mmx-bridge) | 10 | 🟢 ok | untranslated |
| [dsh-computer-use](https://github.com/988hj7tczd-oss/dsh-computer-use) | 27 | 🟢 ok | untranslated |
...
| [tongflow](https://github.com/tong-io/tongflow) | 1019 | ⚪ unknown | untranslated |
...
| [dsh-free-vision](https://github.com/FuzzySoul/dsh-free-vision) | 7 | 🟢 ok | untranslated |
...
| [opencode2dsh](https://github.com/FishBottle7/opencode2dsh) | 47 | ⚪ unknown | untranslated |
| [dsh-better-reasoning-effort](https://github.com/HaoyueQin/dsh-better-reasoning-effort) | 20 | 🟢 ok | untranslated |
| [dsh-purge](https://github.com/YuJunZhiXue/dsh-purge) | 502 | 🟢 ok | untranslated |
| [dsh-design-qa](https://github.com/sunxin-ai/dsh-design-qa) | 43 | 🟢 ok | untranslated |
| [dsh-llm-workbuddy](https://github.com/Axiaohungry/dsh-llm-workbuddy) | 30 | 🟢 ok | untranslated |
...
| [dsh-key-rotation](https://github.com/GooDAnDReaDY/dsh-key-rotation) | 3 | 🟢 ok | 每服务商一个 API key 池：配额/限流错误自动切下一个 key，冷却后探测恢复，可在 Settings 里编辑。 |
| [dsh-subscriptions](https://github.com/GooDAnDReaDY/dsh-subscriptions) | 1 | 🟢 ok | 把 ChatGPT Codex/Claude/Grok/Antigravity 订阅通过 OAuth 注册成 LLM 提供者，免 API key。 |
| [dsh-model-sync](https://github.com/GooDAnDReaDY/dsh-model-sync) | 0 | 🟢 ok | 模型目录自动同步：API-key 提供者的模型清单直接从服务商拉取，不再手工维护。 |
...
| [dsh-plugin-net-access](https://github.com/Gumiho12345/dsh-plugin-net-access) | 6 | 🟢 ok | untranslated |

### 🎛️ 编排

| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [openhanako](https://github.com/liliMozi/openhanako) | 6526 | ⚪ unknown | 带记忆、人格与自主性的个人 AI 智能体 |
| [exo](https://github.com/exoharness/exo) | 1380 | ⚪ unknown | 可递归自编辑自身的 agent+harness 架构 |
| [synergy](https://github.com/SII-Holos/synergy) | 490 | ⚪ unknown | 面向 Open Agentic Web 的通用智能体 |
| [ccteam](https://github.com/firstintent/ccteam) | 499 | ⚪ unknown | 把 Claude Code/Codex/Grok/Kimi 编成团队，Telegram/飞书指挥 |
...
| [distill](https://github.com/LoserFox/distill) | 24 | ⚪ unknown | 自动对话蒸馏：后台 subagent 反省 + 技能更新 |
| [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1494 | 🟢 ok | AgentTeams 插件 |
...
| [dsh-work](https://github.com/vibeinging/dsh-desktop) | 583 | ⚪ unknown | 本地优先 DSH 桌面工作台（原 dsh-work 更名 dsh-desktop） |
...
| [dsh-deep-research](https://github.com/omdsh-dev/dsh-deep-research) | 22 | ⚪ unknown | 自适应深度研究编排插件 |
...
| [dsh-voice](https://github.com/Jesse-njx/dsh-voice) | 3 | 🟢 ok | dsh-voice — DSH 插件（编排） |
...
| [dsh-preset-minimal-windows](https://github.com/zeroa234/dsh-preset-minimal-windows) | 4 | ⚪ unknown | Windows 极简 Agent 预设 + Git Bash 工具：官方极简模式的 Windows 平替。 |
...
| [dsh-kun-like-pet](https://github.com/liyupi/dsh-kun-like-pet) | 91 | 🟢 ok | Kun Like 桌宠 —— DeepSeek Harness 桌面宠物插件：右下角小坤宠随 Agent 工作状态切换 9 种动作，任务完成播放「你干嘛~哎哟」 |
| [dsh-file-review](https://github.com/left0ver/dsh-file-review) | 37 | 🟢 ok | 改完就能审：agent 刚动过的文件直接看 diff，不用离开 DSH Web。 |
| [embedded-workbench](https://github.com/AmethystLuna/embedded-workbench) | 10 | ⚪ unknown | 嵌入式 C/C++ AI 工程插件：固件技能（FreeRTOS、Keil、HardFault 调试）。 |
...
| [Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills) | 3226 | ⚪ unknown | 通用技能调度器：自动挑选最合适的本地 Skill 并编排整个 Harness 工作流，不用手动指定用哪个技能。 |
...
| [dsh-dynamic-island](https://github.com/YLifeOnlyOnce/dsh-dynamic-island) | 4 | 🟢 ok | 玻璃质感小挂件：agent 思考时它会呼吸，任务完成弹提醒，像 iPhone 灵动岛一样陪在旁边。 |
...
| [sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | 146 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | 88 个可直接安装的 Agent 技能：覆盖研究与增长工作流，带 npm CLI 分发。 |
...
| [dsh-opencode-usage](https://github.com/vinyumao/dsh-opencode-usage) | 4 | 🟢 ok | DSH plugin: OpenCode Go 套餐用量显示（滚动/每周/每月用量百分比与重置倒计时 + Agent 工具 opencode_go_usage）。官方 bundle 插件，安装: dsh plugin --profile web add gi… |
...
| [dsh-live2d-pets](https://github.com/cyanfish-x/dsh-live2d-pets) | 19 | 🟢 ok | Live2D 桌宠插件 for DeepSeek Harness：Agent 状态镜像 + 互动陪伴，内置宽松许可预设模型 / Live2D pet plugin: agent state mirror + interactive companion wit… |
...
| [oh-my-dsh](https://github.com/Jonah-Wu23/oh-my-dsh) | 3 | 🟢 ok | untranslated |
...
| [dsh-zotero](https://github.com/Vncntvx/dsh-zotero) | 16 | 🟢 ok | untranslated |
...
| [dsh_workflow](https://github.com/omdsh-dev/dsh_workflow) | 119 | 🔴 broken (dump-config exit=0 but plugin not found in composed tree) | untranslated |
| [dsh-expert-mode](https://github.com/Asher-2000/dsh-expert-mode) | 12 | 🟢 ok | untranslated |
| [dsh-router-flash](https://github.com/xiaoxianyu-office/dsh-router-flash) | 14 | ⚪ unknown | untranslated |
...
| [dsh-file-upload](https://github.com/HongMing-Huang/dsh-file-upload) | 25 | 🟢 ok | untranslated |
...
| [dsh-plugin-mcp-manager](https://github.com/HuanLinOTO/dsh-plugin-mcp-manager) | 5 | 🟢 ok | untranslated |
...
| [dsh-tavern](https://github.com/flizzywine/dsh-tavern) | 214 | 🟢 ok | untranslated |
...
| [dsh-ego-browser](https://github.com/Fisfzy/dsh-ego-browser) | 138 | 🟢 ok | untranslated |
| [dsh-ux](https://github.com/ayuanwong/dsh-ux) | 15 | ⚪ unknown | untranslated |
| [dsh-agency-agents](https://github.com/MichengAI/dsh-agency-agents) | 42 | ⚪ unknown | untranslated |
...
| [dsh-Mimir-Academic-research](https://github.com/1692775560/dsh-Mimir-Academic-research) | 280 | ⚪ unknown | untranslated |
| [dsh-better-input](https://github.com/DIAG5/dsh-better-input) | 27 | 🟢 ok | untranslated |
| [dsh-watcher](https://github.com/aa2246740/dsh-watcher) | 16 | ⚪ unknown | untranslated |
| [mattpocock-skills-dsh](https://github.com/gongyijie85/mattpocock-skills-dsh) | 13 | 🟢 ok | untranslated |
| [loopx](https://github.com/huangruiteng/loopx) | 5767 | ⚪ unknown | untranslated |
| [sofagent](https://github.com/KongFangXun/sofagent) | 43 | ⚪ unknown | untranslated |
| [dsh-ultramath](https://github.com/Andiii208/dsh-ultramath) | 19 | 🟢 ok | untranslated |
| [dsh-Visual-Workflow](https://github.com/GZX2211/dsh-Visual-Workflow) | 24 | ⚪ unknown | untranslated |
| [pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) | 136 | ⚪ unknown | untranslated |
| [dsh-plugin-developer-skill](https://github.com/liangdabiao/dsh-plugin-developer-skill) | 21 | ⚪ unknown | untranslated |
| [dsh-hub-cli](https://github.com/pax-beehive/dsh-hub-cli) | 256 | ⚪ unknown | untranslated |
| [dsh-trading](https://github.com/zhu1090093659/dsh-trading) | 152 | ⚪ unknown | untranslated |
| [dsh-evolve-in-git](https://github.com/Kytolly/dsh-evolve-in-git) | 22 | ⚪ unknown | untranslated |
| [DSH-KRouter](https://github.com/398894496-arch/DSH-KRouter) | 37 | ⚪ unknown | untranslated |
| [dsh-antibrow](https://github.com/antibrow/dsh-antibrow) | 95 | 🟢 ok | untranslated |
| [dsh-qa](https://github.com/naodeng/dsh-qa) | 15 | ⚪ unknown | untranslated |
| [dsh-browser-control](https://github.com/caob23/dsh-browser-control) | 11 | 🟢 ok | untranslated |
| [Openwrite](https://github.com/LiPu-jpg/Openwrite) | 699 | ⚪ unknown | untranslated |
...
| [dsh-deepseek-balance](https://github.com/lin-cheng-lab/dsh-deepseek-balance) | 0 | 🟢 ok | DeepSeek API 余额监视器：DSH 右下角悬浮徽章 + 7天/30天用量费用图表 |
...
| [dsh-lsp-actions](https://github.com/PerryLink/dsh-lsp-actions) | 19 | 🟢 ok | dsh-lsp-actions — DSH 插件（桥接） |
| [dsh-chrome](https://github.com/YJSoooooo/dsh-chrome) | 2 | 🟢 ok | dsh-chrome — DSH 插件（桥接） |
| [dsh-exa-mcp](https://github.com/MicroHEROX/dsh-exa-mcp) | 4 | 🟢 ok | dsh-exa-mcp — DSH 插件（桥接） |
...
| [dsh-usage-stats](https://github.com/Ychris12138/dsh-usage-stats) | 147 | 🟢 ok | Token 用量热力图 + 分模型明细 + DeepSeek 账户余额，全部在一个 Web 面板里看。 |
| [deepseek-harness-acp](https://github.com/openma-ai/deepseek-harness-acp) | 27 | ⚪ unknown | ACP 服务器实现：让外部工具通过 Agent Client Protocol 驱动 DSH。 |
| [dsh-quota-panel](https://github.com/brittanistrehlowll-oss/dsh-quota-panel) | 3 | 🟢 ok | Provider 配额/余额角落面板：服务端凭证代理 + 配置驱动的显示。 |
| [pi2dsh](https://github.com/weijiafu14/pi2dsh) | 186 | 🟢 ok | Bridge the Pi and DeepSeek Harness ecosystems: one Pi Host ABI runs unmodified Pi extensions as native DSH plugins. 打通 Pi 与 DSH 生… |
...
| [dsh-weather](https://github.com/sunshine-lang/dsh-weather) | 8 | 🟢 ok | 天气工具：Open-Meteo 免费接口，实时天气 + 多日预报，无需 API key。 |
| [dsh-pdf](https://github.com/sunshine-lang/dsh-pdf) | 8 | 🟢 ok | PDF 工具箱：本地用 pdfjs-dist 提取文本、元数据和指定页，不联网不用 key。 |
...
| [dsh-remote](https://github.com/flymysql/dsh-remote) | 66 | 🟢 ok | 远程接入助手：/remote 命令 + 设置页直接打印 SSH 隧道/反向隧道命令，远程工作区一键连。 |
...
| [dsh-llm-oauth](https://github.com/ziyou979/dsh-llm-oauth) | 6 | ⚪ unknown | OAuth/订阅制 LLM provider 全家桶：Grok、GitHub Copilot、OpenAI Codex、Anthropic、OpenRouter。 |
...
| [deepseek-harness-mobile](https://github.com/sorsama/deepseek-harness-mobile) | 68 | ⚪ unknown | 安卓伴侣应用：聊天、目标、审批与通知，手机随时遥控 DSH。 |
...
| [dsh-LAN](https://github.com/MrMu666/dsh-LAN) | 11 | 🟢 ok | 为DeepSeek harness开启局域网访问及移动端页面的插件 |
...
| [dsh-balance-plugin](https://github.com/Francis-Xavier-code/dsh-balance-plugin) | 61 | 🟢 ok | deepSeek 余额监控与用量统计（DSH 动态 Cordis 插件）：余额监控 · 官方充值入口 · 用量统计 · 三方插件管理 |
| [dsh-web-lan-access](https://github.com/AcidGr/dsh-web-lan-access) | 30 | 🟢 ok | 局域网访问 Web 插件。 |
...
| [dsh-pocket](https://github.com/shaobeichen/dsh-pocket) | 1040 | 🟢 ok | untranslated |
...
| [model-usage-plugin](https://github.com/AKS1st/model-usage-plugin) | 7 | ⚪ unknown | untranslated |
| [dsh-trajectory-governor](https://github.com/chunsi-w/dsh-trajectory-governor) | 13 | ⚪ unknown | untranslated |
| [dsh-usage](https://github.com/Aisland-SJL/dsh-usage) | 91 | 🟢 ok | untranslated |
| [dsh-qq-bridge](https://github.com/TomoyoNatsume/dsh-qq-bridge) | 12 | 🟢 ok | untranslated |
| [dsh-proxy](https://github.com/smanx/dsh-proxy) | 19 | ⚪ unknown | untranslated |
| [dsh-damage-pulse](https://github.com/wssfk12138/dsh-damage-pulse) | 155 | 🟢 ok | untranslated |
| [dsh-reminder](https://github.com/Aisland-SJL/dsh-reminder) | 17 | 🟢 ok | untranslated |
| [dsh-mobile](https://github.com/saya-ch/dsh-mobile) | 245 | 🟢 ok | untranslated |
...
| [dsh-api-balance](https://github.com/02Muller25/dsh-api-balance) | 8 | 🟢 ok | untranslated |
| [dsh-speak](https://github.com/Alan2Z/dsh-speak) | 10 | 🟢 ok | untranslated |
| [sprites-deepseek-plugin](https://github.com/superfly/sprites-deepseek-plugin) | 7 | ⚪ unknown | untranslated |
| [dsh-remote-web-gateway](https://github.com/summer1238/dsh-remote-web-gateway) | 143 | 🟢 ok | untranslated |
| [dsh-web-startup-auth](https://github.com/GDWhisper/dsh-web-startup-auth) | 30 | 🟢 ok | untranslated |
| [dsh-zen-remote](https://github.com/KyoMio/dsh-zen-remote) | 8 | 🟢 ok | untranslated |
| [dsh-balance-plugin](https://github.com/yxxbc/dsh-balance-plugin) | 61 | 🟢 ok | untranslated |
...
| [dsh-remote](https://github.com/SCSpotato/dsh-remote) | 67 | 🟢 ok | untranslated |
| [dsh-plugin-hub](https://github.com/wingsky-1/dsh-plugin-hub) | 15 | 🟢 ok | untranslated |
| [dsh-remote](https://github.com/mrRisega/dsh-remote) | 47 | 🟢 ok | untranslated |
...
| 插件 | ⭐ | 兼容 | 描述 |
|---|---|---|---|
| [EchoBird](https://github.com/edison7009/EchoBird) | 3188 | ⚪ unknown | 一键安装+切换 Claude Code/Codex/Kimi/Qwen 等 20+ 编码智能体 |
| [awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) | 1460 | ⚪ unknown | DSH 插件目录，带每日兼容性跟踪 |
| [deepseek-harness-applicants](https://github.com/Octo-o-o-o/deepseek-harness-applicants) | 53 | ⚪ unknown | DSH 内测申请者名单 |
| [awesome-deepseek-harness](https://github.com/0xsline/awesome-deepseek-harness) | 1036 | ⚪ unknown | DSH 生态精选：插件、工具与基建 |
| [dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui) | 268 | 🟢 ok | DSH 终端 UI（TUI） |
...
| [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 614 | ⚪ unknown | 2005 年中文站点风格侧栏广告插件（恶搞） |
...
| [oh-dsh-desktop](https://github.com/hust-open-atom-club/oh-dsh-desktop) | 309 | 🔴 broken (dump-config exit=1 but plugin not found in composed tree) | 可扩展的 macOS DSH 工作台（原生 PTY） |
...
| [oh-my-dsh](https://github.com/LaplaceYoung/oh-my-dsh) | 56 | 🟢 ok | 面向 DSH 的插件生态（700+ 插件） |
...
| [dsh-grok-tui](https://github.com/chen-001/dsh-grok-tui) | 10 | 🟢 ok | 用 grok-build 的 TUI 跑 DSH |
...
| [awesome-dsh-plugin](https://github.com/bruc3van/awesome-dsh-plugin) | 323 | ⚪ unknown | 双语 DSH 插件生态完整列表 |
...
| [create-dsh-plugin](https://github.com/whyihaveyou/dsh-suite) | 3 | 🟢 ok | 一键脚手架生成 DeepSeek Harness (DSH) 插件：tool / events / webui 三套模板、next 标签版本锁定、内置 --verify 冒烟测试。 |
| [dsh-101](https://github.com/bill9109/dsh-101) | 6 | ⚪ unknown | DSH 文档阅读模式 |
...
| [dsh-plugin-approval-alert](https://github.com/doncelee229-cmyk/dsh-plugin-approval-alert) | 1 | 🟢 ok | DeepSeek Harness 审批/选择方案系统级通知提醒，显示工作区名、点击跳转、多语言。Approval & decision alerts with native notifications for DeepSeek Harness. |
...
| [dsh-fschannel](https://github.com/cershuang/dsh-fschannel) | 3 | ⚪ unknown | 飞书通道：新建会话选「连接飞书」，飞书消息直接进 DSH 会话。 |
| [dsh-notifier](https://github.com/THEWOLFWALKER/dsh-notifier) | 90 | 🟢 ok | untranslated |
| [dsh-lark](https://github.com/sugarforever/dsh-lark) | 27 | ⚪ unknown | untranslated |
| [ax-feishu-bridge](https://github.com/AX1202/ax-feishu-bridge) | 47 | 🟢 ok | untranslated |
...
| [dsh-meow-smooth](https://github.com/Phant0Meow/dsh-meow-smooth) | 41 | ⚪ unknown | untranslated |
| [harness-one](https://github.com/chumingjun/harness-one) | 17 | ⚪ unknown | untranslated |
| [dsh-dingtalk](https://github.com/DingTalk-Real-AI/dsh-dingtalk) | 15 | 🟢 ok | untranslated |
...
| [dsh-plugin-mobile-gateway](https://github.com/Clarklevis1995/dsh-plugin-mobile-gateway) | 15 | 🟢 ok | untranslated |
| [tarocub](https://github.com/cloveric/tarocub) | 12 | ⚪ unknown | untranslated |
| [dsh-lanmode](https://github.com/GooDAnDReaDY/dsh-lanmode) | 3 | 🟢 ok | 局域网/反代访问 Web UI：让 settings 服务脱离 localhost，补上浏览器在纯 HTTP 下不给的 Web API。 |

> 徽章含义：🟢 兼容 · 🔴 不兼容 · ⚪ 未实测 · ⚫ 弃坑。
> 共 1875 个条目，按分类分表、类内按 ⭐ 降序。收录 / 字段词典见 [docs/catalog-schema.md](docs/catalog-schema.md)。
<!-- CATALOG:END -->
