...
<p align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/images/imagegen-overview.png" alt="dsh-imagegen AI image studio" width="100%" />
</p>

<div align="center">

**让 Agent 不只会回答，还能把想法变成图片，并在成图上继续迭代。**

生成 → 查看 → 加入对话 → 继续编辑，**一条工作流走到底**

[⚡ 快速开始](#quick-start)&nbsp;&nbsp;·&nbsp;&nbsp;[🔄 核心工作流](#workflow)&nbsp;&nbsp;·&nbsp;&nbsp;[⚖️ 多模型对比](#compare)&nbsp;&nbsp;·&nbsp;&nbsp;[🖥️ 工作台](#studio)&nbsp;&nbsp;·&nbsp;&nbsp;[📚 模板库](#templates)&nbsp;&nbsp;·&nbsp;&nbsp;[🎞️ 画廊](#gallery)&nbsp;&nbsp;·&nbsp;&nbsp;[⚙️ 配置](#configuration)&nbsp;&nbsp;·&nbsp;&nbsp;[💬 交流群](#community)
...
<table>
  <tr>
    <td width="33%" align="center" valign="top">
      ...
      <sub>生成 → 查看 → 加入对话 → 继续编辑，出图不是终点</sub><br/>
      <br/>
    </td>
    <td width="33%" align="center" valign="top">
      <br/>
      ...
      <sub>一行命令直接调用插件模型改图，不依赖对话模型的图片能力</sub><br/>
      <br/>
    </td>
    <td width="33%" align="center" valign="top">
      <br/>
  ...
  <tr>
    <td width="33%" align="center" valign="top">
      <br/>
      🖥️<br/>
      <b><a href="#studio">原生三栏工作台</a></b><br/>
    ...
    <td width="33%" align="center" valign="top">
      <br/>
      📚<br/>
      <b><a href="#templates">441 条案例模板库</a></b><br/>
      <sub>搜索分类、一键回填，参考图可缓存离线浏览</sub><br/>
      <br/>
    </td>
    <td width="33%" align="center" valign="top">
      <br/>
      🎞️<br/>
      <b><a href="#gallery">画廊资产管理</a></b><br/>
      <sub>标签、收藏、批量下载、导出备份，跨设备可见</sub><br/>
      <br/>
    </td>
  </tr>
</table>
...
多数生图工具到“下载图片”就结束了，dsh-imagegen 把出图当作起点。开启“允许 Agent 调用生图”后，这条闭环全部在 DSH 里完成：

| 步骤 | 在哪操作 | 发生什么 |
| --- | --- | --- |
| **1️⃣ 生成** | 在对话里直接说，或在生图区输入提示词 | Agent 调用 `generate_image`，或工作台提交任务，由宿主排队执行 |
| **2️⃣ 查看** | 工具结果旁 / 工作台画布 / 全屏预览 | 图片内联显示在对应位置，支持缩放、翻页、复制提示词 |
| **3️⃣ 加入对话** | 结果卡或画廊点“加入对话” | 图片进入当前会话，自动适配附件限制，无需手动上传 |
| **4️⃣ 继续编辑** | 对 Agent 说，或输入 `/edit_image …` | 以上一张成图为参考提交图生图，只需描述要改的地方 |

<div align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/videos/agent-chat-edit.gif" alt="Agent 对话生图与连续编辑演示" width="100%" />
  <p><sub><a href="docs/videos/agent-chat-edit.mp4">▶ 打开高清 MP4 原视频</a>&nbsp;&nbsp;从生成预览区或画廊把图片加入对话，再用 /edit_image 继续修改的完整流程</sub></p>
</div>
...
同一个提示词在不同模型上往往呈现完全不同的构图、质感与文字处理。打开“多模型对比”，勾选多个已配置模型，插件会以相同参数提交任务，并在画布和全屏预览中并列展示——用一次生成的时间，看清哪个模型真正适合当前任务。

<div align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/images/multi-model-comparison.png" alt="gpt-image-2、grok-imagine-image 与 doubao-seedream 的三模型并列结果对比" width="100%" />
...
<div align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/images/image-generation-studio-three-column.png" alt="三栏工作台" width="100%" />
  <p><sub>历史记录 ｜ 生图区 ｜ AI 对话 三栏同屏，分隔线可拖拽</sub></p>
</div>

<div align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/images/image-generation-studio-four.png" alt="AI 生图工作台四图结果布局" width="100%" />
...
随插件内置 441 条精选 `gpt-image-2` 提示词案例（含参考图快照），没有灵感时先逛逛别人怎么写。

<div align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/images/prompt-template-library.png" alt="提示词模板库：分类筛选与案例卡片" width="100%" />
...
满意的图片可从结果卡、全屏预览或历史记录一键加入画廊；画廊中的图片也能直接加入当前对话，再用 `/edit_image` 修改。画廊不是横向缩略图条，而是为持续积累作品设计的纵向工作区：左侧筛选，右侧瀑布流或整齐网格，点击任意图片即可打开大图预览。

<div align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/images/gallery-workspace.png" alt="画廊工作区：分类筛选、瀑布流和大图预览" width="100%" />
...
<div align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/images/plugin-settings.png" alt="DSH 设置页中的 AI 生图插件配置" width="72%" />
...
<p align="center">
  <img src="https://raw.githubusercontent.com/dickpy/dsh-imagegen/4390b408737d30881c0c3d3ad410f82a9d897e9b/docs/images/community-qq.png" alt="扫码加入 dsh-imagegen QQ 交流群" width="360" />
</p>
