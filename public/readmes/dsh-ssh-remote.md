...
![settings](https://raw.githubusercontent.com/zhaenggg/dsh-ssh-remote/8454079c70dc2496f068d3cc448e47e50e2313a1/docs/settings-ssh-v2.png)

*Configure SSH servers in Settings → `SSH` (address, port, credentials). Saved servers appear in the workspace picker.*

![demo](https://raw.githubusercontent.com/zhaenggg/dsh-ssh-remote/8454079c70dc2496f068d3cc448e47e50e2313a1/docs/ssh-session-demo-v3.gif)
