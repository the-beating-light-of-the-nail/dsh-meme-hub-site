...
- `dsh-better-sidebar@0.19.0-alpha.1` is an external npm dependency (not authored in this repo); it must be published before this package's release (see `docs/publish-prep.md` for the release order).
